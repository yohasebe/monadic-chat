...
- **Claude Jupyter Notebook**: Fixed JSON response issue by disabling monadic mode for proper tool execution
...
### Provider-Specific
- **Claude**: Jupyter Notebook requires `monadic false` for tool execution (unlike OpenAI)
