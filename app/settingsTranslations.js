  ...
  en: {
    settings: {
      ...
      labels: {
        ...
        installPrivacyDesc: "English is always installed. Enable additional languages to mask PII in non-English content. Each language adds ~50 MB to the Privacy container; rebuild required after changes.",
  ...
  ja: {
    settings: {
      ...
      labels: {
        ...
        installPrivacyDesc: "英語は常にインストールされます。英語以外のコンテンツで個人情報をマスクするには追加言語を有効化してください。各言語ごとにPrivacyコンテナに約50 MB追加され、変更後はリビルドが必要です。",
  ...
  zh: {
    settings: {
      ...
      labels: {
        ...
        installPrivacyDesc: "英语始终安装。启用附加语言以屏蔽非英语内容中的个人信息。每种语言会向隐私容器添加约 50 MB；更改后需要重新构建。",
  ...
  ko: {
    settings: {
      ...
      labels: {
        ...
        installPrivacyDesc: "영어는 항상 설치됩니다. 영어 이외의 콘텐츠에서 개인정보를 마스킹하려면 추가 언어를 활성화하세요. 각 언어는 Privacy 컨테이너에 약 50 MB를 추가하며 변경 후 재빌드가 필요합니다.",
  ...
  es: {
    settings: {
      ...
      labels: {
        ...
        installPrivacyDesc: "El inglés siempre está instalado. Active idiomas adicionales para enmascarar información personal en contenido no inglés. Cada idioma añade ~50 MB al contenedor de Privacidad; se requiere recompilar tras los cambios.",
  ...
  fr: {
    settings: {
      ...
      labels: {
        ...
        installPrivacyDesc: "L'anglais est toujours installé. Activez des langues supplémentaires pour masquer les informations personnelles dans le contenu non anglais. Chaque langue ajoute ~50 Mo au conteneur Privacy ; reconstruction requise après modification.",
  ...
  de: {
    settings: {
      ...
      labels: {
        ...
        installPrivacyDesc: "Englisch ist immer installiert. Aktivieren Sie weitere Sprachen, um persönliche Daten in nicht-englischen Inhalten zu maskieren. Jede Sprache fügt ca. 50 MB zum Privacy-Container hinzu; nach Änderungen ist ein Neuaufbau erforderlich.",
        installExtractorTitle: "Knowledge Base Quality Pack (Docling)",
