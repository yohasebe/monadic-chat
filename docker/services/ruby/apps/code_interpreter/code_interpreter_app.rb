class CodeInterpreter < MonadicApp
  ...
  description = <<~TEXT
  This is an application that allows you to run Python code. You can also install libraries, run bash commands, fetch text from files, and generate charts. <a href="https://yohasebe.github.io/monadic-chat/#/basic-apps?id=code-interpreter" target="_blank">Learn more</a>.
  TEXT
