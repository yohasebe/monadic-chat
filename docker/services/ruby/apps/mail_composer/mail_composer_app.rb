class MailComposer < MonadicApp
  ...
  initial_prompt = <<~TEXT
    ...
    When suggesting text in English, basically use ASCII characters to represent punctuation marks. For example, use "..." instead of "…", "--" instead of "—", and so on. The same goes for quotation marks, apostrophes, and other symbols.
  TEXT
