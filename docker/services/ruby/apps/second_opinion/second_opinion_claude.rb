...
class SecondOpinionClaude < MonadicApp
  include ClaudeHelper
  include SecondOpinionAgent
  
  # Check if a model is reasoning-based for Claude
  ...
  def self.is_reasoning_model?(model)
    # Claude doesn't have reasoning models that use reasoning_effort
    false
  end
  ...
  # Gets a second opinion on the agent's response
    ...
    # @param provider [String, nil] Optional provider name (e.g., 'openai', 'gemini')
