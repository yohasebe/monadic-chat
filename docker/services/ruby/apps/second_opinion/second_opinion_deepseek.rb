...
class SecondOpinionDeepSeek < MonadicApp
  include DeepSeekHelper
  include SecondOpinionAgent
  
  # Check if a model is reasoning-based for DeepSeek
  ...
  def self.is_reasoning_model?(model)
    # DeepSeek doesn't have reasoning models that use reasoning_effort
    false
  end
