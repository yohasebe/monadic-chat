...
class SecondOpinionPerplexity < MonadicApp
  include PerplexityHelper
  include SecondOpinionAgent
  
  # Check if a model is reasoning-based for Perplexity
  ...
  def self.is_reasoning_model?(model)
    # Perplexity doesn't have reasoning models that use reasoning_effort
    false
  end
