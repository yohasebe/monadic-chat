...
class ChatWithClaude < MonadicApp
  ...
  description = <<~TEXT
  This app accesses the Anthropic API to answer questions about a wide range of topics. The answers are generated by the Anthropic model, which is a powerful AI model that can provide detailed and accurate responses to a wide range of questions. <a href="https://yohasebe.github.io/monadic-chat/#/language-models?id=anthropic" target="_blank">Learn more</a>.
  TEXT
