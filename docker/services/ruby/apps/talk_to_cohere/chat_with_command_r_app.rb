...
class ChatWithCommandR < MonadicApp
  ...
  description = <<~TEXT
  This app accesses the Cohere Command R API to answer questions about a wide range of topics. The answers are generated by the Command R model, which is a powerful AI model that can provide detailed and accurate responses to a wide range of questions. <a href="https://yohasebe.github.io/monadic-chat/#/language-models?id=cohere" target="_blank">Learn more</a>.
  TEXT
