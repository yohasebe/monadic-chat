...
class ChatDeepSeek < MonadicApp
  include DeepSeekHelper

  icon = "<i class='fa-solid fa-d'></i>"

  description = <<~TEXT
    This app accesses the DeepSeek API to answer questions about a wide range of topics. The answers are generated by the DeepSeek model, which is a powerful AI model that can provide detailed and accurate responses to a wide range of questions. <a href="https://yohasebe.github.io/monadic-chat/#/language-models?id=deepseek" target="_blank"><i class="fa-solid fa-circle-info"></i></a>
