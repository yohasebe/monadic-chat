...
class ChatWithMistral < MonadicApp
  ...
  description = <<~TEXT
  This app accesses the Mistral AI API to answer questions about a wide range of topics. The answers are generated by the Mistral model, which is a powerful AI model that can provide detailed and accurate responses to a wide range of questions. <a href="https://yohasebe.github.io/monadic-chat/#/language-models?id=mistral" target="_blank">Learn more</a>.
