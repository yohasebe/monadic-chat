class VoiceChat < MonadicApp
  ...
  description = <<~TEXT
  This app enables users to chat using voice through OpenAI's Whisper voice-to-text API and text-to-speech API. The initial prompt is the same as the one for the Chat app. <a href="https://yohasebe.github.io/monadic-chat/#/basic-apps?id=voice-chat" target="_blank">Learn more</a>.
  TEXT
