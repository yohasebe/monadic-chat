  ...
  en: {
    ui: {
      ...
      messages: {
        ...
        gpt5CodexDelegating: "Delegating to GPT-5-Codex specialist agent",
        ...
        claudeOpusAnalyzing: "Claude Opus is analyzing requirements",
        claudeOpusGenerating: "Claude Opus is generating code",
        claudeOpusStructuring: "Claude Opus is structuring the solution",
        claudeOpusOptimizing: "Claude Opus is optimizing the implementation",
        claudeOpusFinalizing: "Claude Opus is finalizing the output",
        gpt5CodexComplexTask: "Complex task in progress",
        agentProcessing: "Agent is processing request",
        agentAnalyzing: "Agent is analyzing data",
        agentFinalizing: "Agent is finalizing response",
  ...
  ja: {
    ui: {
      ...
      messages: {
        ...
        gpt5CodexDelegating: "GPT-5-Codex専門エージェントに委譲中",
        ...
        claudeOpusAnalyzing: "Claude Opusが要件を分析中",
        claudeOpusGenerating: "Claude Opusがコードを生成中",
        claudeOpusStructuring: "Claude Opusがソリューションを構築中",
        claudeOpusOptimizing: "Claude Opusが実装を最適化中",
        claudeOpusFinalizing: "Claude Opusが出力を仕上げています",
        gpt5CodexComplexTask: "複雑なタスクを処理中",
        agentProcessing: "エージェントがリクエストを処理中",
        agentAnalyzing: "エージェントがデータを分析中",
        agentFinalizing: "エージェントが応答を完成中",
  ...
  zh: {
    ui: {
      ...
      messages: {
        ...
        claudeOpusAnalyzing: "Claude Opus正在分析需求",
        claudeOpusGenerating: "Claude Opus正在生成代码",
        claudeOpusStructuring: "Claude Opus正在构建解决方案",
        claudeOpusOptimizing: "Claude Opus正在优化实现",
        claudeOpusFinalizing: "Claude Opus正在完成输出",
        gpt5CodexComplexTask: "复杂任务进行中",
        agentProcessing: "代理正在处理请求",
        agentAnalyzing: "代理正在分析数据",
        agentFinalizing: "代理正在完成响应",
  ...
  ko: {
    ui: {
      ...
      messages: {
        ...
        claudeOpusAnalyzing: "Claude Opus가 요구사항을 분석 중",
        claudeOpusGenerating: "Claude Opus가 코드를 생성 중",
        claudeOpusStructuring: "Claude Opus가 솔루션을 구성 중",
        claudeOpusOptimizing: "Claude Opus가 구현을 최적화 중",
        claudeOpusFinalizing: "Claude Opus가 출력을 마무리 중",
        gpt5CodexComplexTask: "복잡한 작업 진행 중",
        agentProcessing: "에이전트가 요청을 처리 중",
        agentAnalyzing: "에이전트가 데이터를 분석 중",
        agentFinalizing: "에이전트가 응답을 완성 중",
  ...
  es: {
    ui: {
      ...
      messages: {
        ...
        claudeOpusAnalyzing: "Claude Opus está analizando requisitos",
        claudeOpusGenerating: "Claude Opus está generando código",
        claudeOpusStructuring: "Claude Opus está estructurando la solución",
        claudeOpusOptimizing: "Claude Opus está optimizando la implementación",
        claudeOpusFinalizing: "Claude Opus está finalizando el resultado",
        gpt5CodexComplexTask: "Tarea compleja en progreso",
        agentProcessing: "El agente está procesando la solicitud",
        agentAnalyzing: "El agente está analizando datos",
        agentFinalizing: "El agente está finalizando la respuesta",
  ...
  fr: {
    ui: {
      ...
      messages: {
        ...
        claudeOpusAnalyzing: "Claude Opus analyse les exigences",
        claudeOpusGenerating: "Claude Opus génère du code",
        claudeOpusStructuring: "Claude Opus structure la solution",
        claudeOpusOptimizing: "Claude Opus optimise l'implémentation",
        claudeOpusFinalizing: "Claude Opus finalise le résultat",
        gpt5CodexComplexTask: "Tâche complexe en cours",
        agentProcessing: "L'agent traite la demande",
        agentAnalyzing: "L'agent analyse les données",
        agentFinalizing: "L'agent finalise la réponse",
  ...
  de: {
    ui: {
      ...
      messages: {
        ...
        claudeOpusAnalyzing: "Claude Opus analysiert Anforderungen",
        claudeOpusGenerating: "Claude Opus generiert Code",
        claudeOpusStructuring: "Claude Opus strukturiert die Lösung",
        claudeOpusOptimizing: "Claude Opus optimiert die Implementierung",
        claudeOpusFinalizing: "Claude Opus finalisiert das Ergebnis",
        gpt5CodexComplexTask: "Komplexe Aufgabe läuft",
        agentProcessing: "Agent verarbeitet Anfrage",
        agentAnalyzing: "Agent analysiert Daten",
        agentFinalizing: "Agent finalisiert Antwort",
