  ...
  en: {
    ui: {
      ...
      messages: {
        ...
        lcStart: "Start live conversation",
        ...
        lcVoice: "Voice",
        lcVoiceNextStart: "(applies from the next Start)",
        lcSpeed: "Speed",
        lcWebsearch: "Web search",
        lcWebsearchCostXai: "(may incur additional charges)",
        lcWebsearchCostGemini: "(sources not shown; free monthly quota, then paid)",
        lcStop: "End live conversation",
  ...
  ja: {
    ui: {
      ...
      messages: {
        ...
        lcVoice: "音声",
        lcVoiceNextStart: "（次の開始から適用）",
        lcSpeed: "速度",
        lcWebsearch: "Web検索",
        lcWebsearchCostXai: "（追加料金の可能性）",
        lcWebsearchCostGemini: "（出典は表示されません・月間無料枠あり・超過後は有料）",
        lcStop: "ライブ会話を終了",
        lcConnecting: "接続中…",
        lcListening: "聞き取り中…",
  ...
  zh: {
    ui: {
      ...
      messages: {
        ...
        lcVoice: "语音",
        lcVoiceNextStart: "（下次开始时生效）",
        lcSpeed: "速度",
        lcWebsearch: "网络搜索",
        lcWebsearchCostXai: "（可能产生额外费用）",
        lcWebsearchCostGemini: "（不显示来源；每月有免费额度，超出后收费）",
        lcStop: "结束实时对话",
        lcConnecting: "连接中…",
        lcListening: "正在聆听…",
  ...
  ko: {
    ui: {
      ...
      messages: {
        ...
        lcVoice: "음성",
        lcVoiceNextStart: "(다음 시작부터 적용)",
        lcSpeed: "속도",
        lcWebsearch: "웹 검색",
        lcWebsearchCostXai: "(추가 요금이 발생할 수 있음)",
        lcWebsearchCostGemini: "(출처가 표시되지 않음・월 무료 한도 초과 시 유료)",
        lcStop: "실시간 대화 종료",
        lcConnecting: "연결 중…",
        lcListening: "듣는 중…",
  ...
  es: {
    ui: {
      ...
      messages: {
        ...
        lcStart: "Iniciar conversación en vivo",
        ...
        lcVoice: "Voz",
        lcVoiceNextStart: "(se aplica desde el próximo inicio)",
        lcSpeed: "Velocidad",
        lcWebsearch: "Búsqueda web",
        lcWebsearchCostXai: "(puede generar cargos adicionales)",
        lcWebsearchCostGemini: "(sin mostrar fuentes; cuota mensual gratuita, luego de pago)",
        lcStop: "Terminar conversación en vivo",
  ...
  fr: {
    ui: {
      ...
      messages: {
        ...
        lcStart: "Démarrer la conversation en direct",
        ...
        lcVoice: "Voix",
        lcVoiceNextStart: "(appliqué au prochain démarrage)",
        lcSpeed: "Vitesse",
        lcWebsearch: "Recherche web",
        lcWebsearchCostXai: "(frais supplémentaires possibles)",
        lcWebsearchCostGemini: "(sources non affichées ; quota mensuel gratuit, puis payant)",
        lcStop: "Terminer la conversation en direct",
  ...
  de: {
    ui: {
      ...
      messages: {
        ...
        lcVoice: "Stimme",
        lcVoiceNextStart: "(gilt ab dem nächsten Start)",
        lcSpeed: "Tempo",
        lcWebsearch: "Websuche",
        lcWebsearchCostXai: "(zusätzliche Kosten möglich)",
        lcWebsearchCostGemini: "(Quellen nicht angezeigt; kostenloses Monatskontingent, danach kostenpflichtig)",
        lcStop: "Live-Gespräch beenden",
