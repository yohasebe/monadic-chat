...
const webUITranslations = {
  en: {
    ui: {
      ...
      aiAssistantAndUser: "AI Assistant & User",
      github: "GitHub",
      version: "Version",
  ...
  ja: {
    ui: {
      ...
      aiAssistantAndUser: "AIアシスタント & ユーザー",
      github: "GitHub",
      version: "バージョン",
  ...
  ko: {
    ui: {
      ...
      aiAssistantAndUser: "AI 어시스턴트 & 사용자",
      github: "GitHub",
      version: "버전",
      currentBaseApp: "현재 앱",
      selectApp: "앱 선택",
  ...
  es: {
    ui: {
      ...
      aiAssistantAndUser: "Asistente IA y Usuario",
      github: "GitHub",
      version: "Versión",
