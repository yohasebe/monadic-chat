...
const webUITranslations = {
  en: {
    ui: {
      ...
      expressiveSpeechTooltip: "The selected TTS engine interprets speech markers that the assistant weaves into its replies.",
  ...
  ja: {
    ui: {
      ...
      expressiveSpeechTooltip: "選択中のTTSエンジンが、アシスタントの応答に埋め込まれた音声マーカーを表現豊かに読み上げます。",
  ...
  zh: {
    ui: {
      ...
      expressiveSpeechTooltip: "所选 TTS 引擎会解释助手回复中嵌入的语音标记，使语音更富有表现力。",
  ...
  ko: {
    ui: {
      ...
      expressiveSpeechTooltip: "선택된 TTS 엔진이 어시스턴트의 응답에 포함된 음성 마커를 해석하여 표현력 있게 읽어줍니다.",
  ...
  es: {
    ui: {
      ...
      expressiveSpeechTooltip: "El motor TTS seleccionado interpreta marcadores de habla que el asistente incorpora en sus respuestas.",
  ...
  fr: {
    ui: {
      ...
      expressiveSpeechTooltip: "Le moteur TTS sélectionné interprète les marqueurs vocaux que l'assistant intègre dans ses réponses.",
  ...
  de: {
    ui: {
      ...
      expressiveSpeechTooltip: "Die ausgewählte TTS-Engine interpretiert Sprachmarkierungen, die der Assistent in seine Antworten einfügt.",
