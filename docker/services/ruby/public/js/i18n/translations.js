...
const webUITranslations = {
  en: {
    ui: {
      ...
      pdfRefreshCloud: "Refresh cloud PDF list",
      pdfClearCloud: "Clear all PDFs from cloud database",
  ...
  zh: {
    ui: {
      ...
      pdfRefreshCloud: "刷新云端PDF列表",
      pdfClearCloud: "清除云端数据库中的所有PDF",
  ...
  es: {
    ui: {
      ...
      noPdfsCloud: "Sin PDFs en la nube",
      ...
      pdfRefreshCloud: "Actualizar lista de PDF en la nube",
      pdfClearCloud: "Eliminar todos los PDF de la base de datos en la nube",
  ...
  fr: {
    ui: {
      ...
      pdfRefreshCloud: "Actualiser la liste des PDF cloud",
      pdfClearCloud: "Supprimer tous les PDF de la base de données cloud",
  ...
  de: {
    ui: {
      ...
      pdfRefreshCloud: "Cloud-PDF-Liste aktualisieren",
      pdfClearCloud: "Alle PDFs aus Cloud-Datenbank löschen",
      monadicChatInfo: "Monadic Chat Info",
      monadicChatStatus: "Monadic Chat Status",
