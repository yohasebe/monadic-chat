  ...
  en: {
    ui: {
      ...
      messages: {
        ...
        stsSpeakToStart: "Realtime voice model: press the microphone and speak to start the conversation.",
        stsModeNotice: "Realtime voice model: conversation runs over the speech-to-speech bridge. Web search and typed messages are not available in this mode.",
  ...
  ja: {
    ui: {
      ...
      messages: {
        ...
        stsSpeakToStart: "リアルタイム音声モデル: マイクボタンを押して話しかけると会話が始まります。",
        stsModeNotice: "リアルタイム音声モデル: 会話は音声対音声ブリッジ経由になります。このモードではウェブ検索とテキスト入力は使えません。",
  ...
  zh: {
    ui: {
      ...
      messages: {
        ...
        stsSpeakToStart: "实时语音模型：按下麦克风按钮开始说话即可开始对话。",
        stsModeNotice: "实时语音模型：对话通过语音到语音桥接进行。此模式下无法使用网页搜索和文字输入。",
  ...
  ko: {
    ui: {
      ...
      messages: {
        ...
        stsSpeakToStart: "실시간 음성 모델: 마이크 버튼을 누르고 말하면 대화가 시작됩니다.",
        stsModeNotice: "실시간 음성 모델: 대화는 음성 대 음성 브리지를 통해 진행됩니다. 이 모드에서는 웹 검색과 텍스트 입력을 사용할 수 없습니다.",
  ...
  es: {
    ui: {
      ...
      messages: {
        ...
        stsSpeakToStart: "Modelo de voz en tiempo real: pulse el micrófono y hable para iniciar la conversación.",
        stsModeNotice: "Modelo de voz en tiempo real: la conversación pasa por el puente de voz a voz. La búsqueda web y los mensajes escritos no están disponibles en este modo.",
  ...
  fr: {
    ui: {
      ...
      messages: {
        ...
        stsSpeakToStart: "Modèle vocal temps réel : appuyez sur le micro et parlez pour démarrer la conversation.",
        stsModeNotice: "Modèle vocal temps réel : la conversation passe par le pont voix-à-voix. La recherche web et les messages tapés ne sont pas disponibles dans ce mode.",
  ...
  de: {
    ui: {
      ...
      messages: {
        ...
        stsSpeakToStart: "Echtzeit-Sprachmodell: Mikrofon drücken und sprechen, um das Gespräch zu beginnen.",
        stsModeNotice: "Echtzeit-Sprachmodell: Die Konversation läuft über die Sprache-zu-Sprache-Brücke. Websuche und getippte Nachrichten sind in diesem Modus nicht verfügbar.",
