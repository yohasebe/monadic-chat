...
const webUITranslations = {
  en: {
    ui: {
      ...
      privacyFilterNotInstalled: "Privacy Filter is not installed. Open Settings → Install Options to enable it.",
      ...
      modals: {
        ...
        saveAndReset: "Save to Knowledge Base & Reset",
  ...
  ja: {
    ui: {
      ...
      privacyFilterNotInstalled: "プライバシーフィルターはインストールされていません。設定 → Install Options で有効化できます。",
  ...
  zh: {
    ui: {
      ...
      privacyFilterNotInstalled: "隐私过滤器未安装。请打开设置 → Install Options 以启用。",
  ...
  ko: {
    ui: {
      ...
      privacyFilterNotInstalled: "개인정보 필터가 설치되어 있지 않습니다. 설정 → Install Options 에서 활성화하세요.",
  ...
  es: {
    ui: {
      ...
      privacyFilterNotInstalled: "El Filtro de privacidad no está instalado. Abra Configuración → Install Options para habilitarlo.",
      ...
      modals: {
        ...
        saveAndReset: "Guardar en la base de conocimiento y reiniciar",
  ...
  fr: {
    ui: {
      ...
      privacyFilterNotInstalled: "Le filtre de confidentialité n'est pas installé. Ouvrez Paramètres → Install Options pour l'activer.",
      ...
      modals: {
        ...
        saveAndReset: "Enregistrer dans la base de connaissances et réinitialiser",
  ...
  de: {
    ui: {
      ...
      privacyFilterNotInstalled: "Privatsphäre-Filter ist nicht installiert. Öffnen Sie Einstellungen → Install Options, um ihn zu aktivieren.",
      ...
      modals: {
        ...
        saveAndReset: "In Wissensdatenbank speichern und zurücksetzen",
