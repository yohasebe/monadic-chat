...
const webUITranslations = {
  en: {
    ui: {
      helpData: {
        title: "Help Data",
        description: "Install the bundled documentation for Help search. No API key is needed to install it.",
        checking: "Checking Help data...",
        not_installed: "Help data is not installed.",
        installing: "Installing Help data...",
        installed: "Help data is ready to search.",
        update_available: "A Help data update is available. You can keep searching the installed version.",
        legacy: "Help data needs to be reinstalled before searching.",
        failed: "Help data installation failed.",
        unavailable: "The Help data service is unavailable.",
        install: "Install",
        update: "Update",
        reinstall: "Reinstall",
        ...
        completed: "Completed",
        busy: "Help data is busy. Check its status and retry if needed.",
        startFailed: "Could not start installation. Check the service and retry."
      },
      verify: {
      ...
      workflowViewerLoadFailed: "Failed to load the workflow viewer.",
      workflowViewerRetry: "Retry",
      workflowViewerHidden: "Hidden",
      workflowViewerInline: "In Panel",
      workflowViewerFloating: "Floating",
      status: "Status",
      mode: "Mode",
      ...
      sttNoModelsAvailable: "No STT models available (API key required)",
      expressiveSpeech: "Expressive Speech",
      expressiveSpeechTooltip: "The selected TTS engine interprets speech markers (pauses, laughter, whispers) that the assistant weaves into its replies. Supported by xAI Grok, ElevenLabs v3, and Gemini TTS.",
      expressiveSpeechInstructionsTooltip: "The assistant emits an out-of-band voice directive (tone, pacing, emotion) that the OpenAI gpt-4o-mini-tts engine reads but does not speak aloud. Only the reply text is voiced — with expressive styling matched to the content.",
      ...
      noPdfsLocal: "No PDFs imported",
      pdfImportFile: "Import PDF file to local database",
      pdfRefreshLocal: "Refresh local PDF list",
      pdfClearLocal: "Clear all PDFs from local database",
      knowledgeBase: "Knowledge Base",
      libSaveCurrent: "Save current conversation to Knowledge Base",
      libSaveShort: "Save",
      libRefresh: "Refresh Knowledge Base list",
      libSaveModalTitle: "Save Conversation to Knowledge Base",
      libTitleLabel: "Title (optional)",
      libTitleHint: "If left blank, the app name is used as the title.",
      libScopeLabel: "Scope",
      libScopeAppOnlyLabel: "App-only",
      libScopeAppOnlyDesc: "Only retrievable from this same app + provider.",
      libScopeGlobalLabel: "Global",
      libScopeGlobalDesc: "Retrievable from every app via library_search.",
      libScopeGlobalWarning: "Global entries are searchable from every app in this Monadic Chat install. Anyone with access to this machine — including future apps you have not yet picked — can retrieve this content via library_search. Prefer App-only unless the conversation is intentionally shared.",
      libBadgePiiHeuristic: "May contain PII (email or phone pattern detected in title/source)",
      libSaveButton: "Save",
      libEmpty: "The Knowledge Base is empty.",
      libSaveSuccess: "Saved to Knowledge Base.",
      libSaveModalTitleUpdate: "Update Conversation in Knowledge Base",
      libUpdateButton: "Update",
      libUpdateNote: "This will replace the previous saved version of this conversation.",
      libUpdateSuccess: "Updated existing Knowledge Base entry.",
      libSuggestingTitle: "Suggesting title…",
      libSaveFailure: "Failed to save",
      libSavingButton: "Saving...",
      libSavingMessage: "Saving conversation to Knowledge Base...",
      libNoMessages: "There are no messages to save yet.",
      libSaveAppUnsupported: "This app does not support saving to the Knowledge Base.",
      libSavePrivacyActive: "Saving is disabled while the Privacy Filter is active in this session.",
      libImportFile: "Import file",
      libImportTooltip: "Import a Markdown / PDF / Office / code file into the Knowledge Base",
      libImportingButton: "Importing...",
      libImportingMessage: "Importing file into Knowledge Base...",
      ...
      libImportSuccess: "Imported to Knowledge Base",
      libImportFailure: "Failed to import",
      libRagToggleLabel: "Use Knowledge Base for retrieval (this session)",
      libRagToggleHint: "When ON, apps that support tools can retrieve from shareable conversations via library_search. Default OFF.",
      libBrowseAll: "Browse all saved conversations",
      libBrowseAllShort: "Browse",
      libRecentLabel: "Recent saves:",
      libBrowseModalTitle: "Knowledge Base Browser",
      libBrowsePlaceholder: "Search title, source, language...",
      libBrowseAllScopes: "All scopes",
      libSortNewest: "Newest first",
      libSortOldest: "Oldest first",
      libSortTitleAsc: "Title A→Z",
      libSortTurnsDesc: "Most turns",
      libColType: "Type",
      libColTypeTooltip: "Content type (conversation / pdf / document / code / ...)",
      libColTitle: "Title",
      libColScope: "Scope",
      libColTurns: "Turns",
      libColCreated: "Saved",
      libBrowseEmpty: "No conversations match your filters.",
      libPrev: "Prev",
      libNext: "Next",
      libDetailTitle: "Conversation Details",
      libMakeAppOnly: "Make app-only: {app}",
      libMakeAppOnlyDisabled: "Switch to an app to scope this entry",
      libMakeGlobal: "Make Global",
      libDelete: "Delete",
      libClose: "Close",
      libViewDetails: "View details",
      libDeleteConfirm: "Permanently delete \"{title}\" from the Knowledge Base?",
      libScopeUpdated: "Scope updated.",
      libRenameTooltip: "Rename this conversation",
      libRenamePlaceholder: "Conversation title",
      libRenameSave: "Save",
      libRenameCancel: "Cancel",
      libRenameSuccess: "Title updated.",
      libRenameFailure: "Failed to rename",
      libRenameEmpty: "Title must not be empty",
      libFiltered: "filtered",
      libShowing: "Showing",
      libViewerTitle: "Conversation Viewer",
      libViewerSystemPrompt: "System prompt",
      libViewerClickToExpand: "click to expand",
      libViewerEmpty: "No verbatim messages were stored for this conversation. Re-save it to enable the Viewer.",
      libViewerLoading: "Loading conversation...",
      libViewerLoadFailure: "Could not load this conversation.",
      libViewerSkipped: "Verbatim messages were not stored (",
      sessionLabel: "Session Controls",
      sessionContext: "Session Context",
      contextTurnLegend: "T = Turn",
      saveChanges: "Save",
      speech: "Speech",
      ...
      fileToImportAll: "File to import (images, PDF, XLSX, DOCX, CSV, etc.)",
      image: "Image",
      ...
      privacyFilterUnsupported: "This app does not support Privacy Filter.",
      privacyFilterNotInstalled: "Privacy Filter is disabled.",
      privacyFilterLanguageNotInstalled: "Privacy Filter is not installed for this language. Install via Settings → Install Options.",
      privacyFilterCaption: "Mask names, emails, and phone numbers before sending to the AI. Locked once a message is sent in this session.",
      exportDialogTitle: "Export Conversation",
      exportEncryptLabel: "Encrypt with passphrase",
      exportEncryptHint: "Protect the exported file at rest using AES-256-GCM + Argon2id. Recommended for files you intend to share, archive, or sync.",
      exportPassphrase: "Passphrase",
      exportPassphraseConfirm: "Confirm",
      exportPassphrasePlaceholder: "Enter a passphrase",
      exportPassphraseWarning: "This passphrase is the ONLY way to recover your data. Monadic Chat cannot reset it.",
      exportContent: "Content",
      exportContentRestored: "Restored — original names and details reconstructed",
      exportContentMasked: "Masked — placeholders only, no registry",
      privacyRegistryEmpty: "No personal information has been masked yet.",
      exportPlainWarningTitle: "Plain export selected.",
      exportPlainWarningBody: "The exported file will contain unencrypted contents. Use only for trusted, local-only workflows.",
      exportRestoredStrongTitle: "PII will be written to disk in plaintext.",
      exportRestoredStrongBody: "Privacy Filter is active in this session, but you are overriding the safer default by choosing \"Restored\" without encryption. The exported file will contain every name, email, address, and phone number visible in the conversation. Pick \"Encrypt and Export\" or switch the content radio back to \"Masked\" if you do not need plaintext PII to leave this machine.",
      ...
      modals: {
        ...
        fileUrlLabel: "Or enter file URL",
        fileToImport: "File to import",
      ...
      messages: {
        ...
        lcStart: "Start",
        lcIntro: "Press \"Start live conversation\" to begin. Speaking then continues hands-free — turns are detected automatically. Press \"End live conversation\" to finish. Headphones are recommended.",
        lcIdleStopped: "No speech for a while — the live conversation ended.",
        lcVoice: "Voice",
        lcSpeed: "Speed",
        lcCardView: "Cards while talking",
        lcTools: "Tools",
        lcTurnDetection: "Turn detection",
        lcTurnSilence: "By silence (default)",
        lcTurnLow: "By meaning — patient",
        lcTurnMedium: "By meaning — balanced",
        lcTurnHigh: "By meaning — quick",
        lcToolUsing: "Using {tool}…",
        lcRoleUser: "You",
        lcRoleAssistant: "Assistant",
        lcStop: "End",
        lcConnecting: "Connecting…",
        lcListening: "Listening…",
        lcUserSpeaking: "You are speaking…",
        lcAssistantSpeaking: "Assistant is speaking…",
        lcReconnecting: "Reconnecting…",
        lcMicFailed: "Microphone access failed. Check permissions and try again.",
        stsStreamStartFailed: "Speech-to-speech audio capture failed. Check microphone access, or switch to a non-realtime model.",
        stsEstimatedCost: "Estimated cost (upper bound)",
        stsEstimatedCostPerMinute: "Estimated cost (per-minute billing)",
        stsEstimateShort: "est.",
        readyToStart: "Ready to start",
        verifyingToken: "Verifying token",
        tokenVerificationTimeout: "Token verification timed out. Proceeding with limited functionality.",
        ...
        generatingAIUserResponse: "AI user responding...",
        ...
        spinnerProcessingAudio: "Processing audio",
        spinnerUpdatingContext: "Updating context",
        ...
        grokCodeGenerating: "The Grok coding agent is generating code",
        grokCodeDelegating: "Delegating to the Grok coding agent",
        ...
        openaiCodeAnalyzing: "The OpenAI coding agent is analyzing requirements",
        openaiCodeGenerating: "The OpenAI coding agent is generating code",
        openaiCodeStructuring: "The OpenAI coding agent is structuring the solution",
        openaiCodeOptimizing: "The OpenAI coding agent is optimizing the implementation",
        openaiCodeFinalizing: "The OpenAI coding agent is finalizing the output",
        claudeCodeAnalyzing: "The Claude coding agent is analyzing requirements",
        claudeCodeGenerating: "The Claude coding agent is generating code",
        claudeCodeStructuring: "The Claude coding agent is structuring the solution",
        claudeCodeOptimizing: "The Claude coding agent is optimizing the implementation",
        claudeCodeFinalizing: "The Claude coding agent is finalizing the output",
        grokCodeAnalyzing: "The Grok coding agent is analyzing requirements",
        grokCodeGenerating2: "The Grok coding agent is generating code",
        grokCodeFinalizing: "The Grok coding agent is finalizing the output",
        ...
        validTokenNotSet: "Valid OpenAI token not set",
        cannotConnectToAPI: "Cannot connect to OpenAI API",
  ...
  ja: {
    ui: {
      helpData: {
        title: "ヘルプデータ",
        description: "ヘルプ検索用に同梱のドキュメントをインストールします。インストールにAPIキーは不要です。",
        checking: "ヘルプデータを確認中...",
        not_installed: "ヘルプデータは未インストールです。",
        installing: "ヘルプデータをインストール中...",
        installed: "ヘルプデータを検索できます。",
        update_available: "ヘルプデータの更新があります。導入済みのデータは引き続き検索できます。",
        legacy: "検索するにはヘルプデータの再インストールが必要です。",
        failed: "ヘルプデータのインストールに失敗しました。",
        unavailable: "ヘルプデータのサービスを利用できません。",
        install: "インストール",
        update: "更新",
        reinstall: "再インストール",
        retry: "インストールを再試行",
        refresh: "状態を更新",
        back: "チャットに戻る",
        validating: "ドキュメントを検証中",
        preparing: "インストールを準備中",
        loading: "ドキュメントを読み込み中",
        verifying: "インストール結果を確認中",
        completed: "完了",
        busy: "ヘルプデータは処理中です。状態を確認し、必要に応じて再試行してください。",
        startFailed: "インストールを開始できませんでした。サービスを確認して再試行してください。"
      },
      verify: {
      ...
      toggleMenu: "メニュー切替",
      workflowViewer: "ワークフロービューア",
      workflowViewerLoadFailed: "ワークフロービューアの読み込みに失敗しました。",
      workflowViewerRetry: "再試行",
      workflowViewerHidden: "非表示",
      workflowViewerInline: "パネル内",
      workflowViewerFloating: "フローティング",
      status: "ステータス",
      mode: "モード",
      standalone: "スタンドアロン",
      server: "サーバー",
      ...
      speechToTextModel: "音声認識モデル",
      sttNoModelsAvailable: "利用可能な音声認識モデルがありません（APIキーが必要）",
      expressiveSpeech: "エクスプレッシブスピーチ",
      expressiveSpeechTooltip: "選択中のTTSエンジンが、アシスタントの応答に埋め込まれた音声マーカー（間・笑い・ささやき）を表現豊かに読み上げます。対応モデル: xAI Grok / ElevenLabs v3 / Gemini TTS。",
      expressiveSpeechInstructionsTooltip: "アシスタントが発話方針（声の質感・テンポ・感情）を別パラメータとして送出し、OpenAI gpt-4o-mini-tts がそれを読み取って抑揚豊かに読み上げます。指示文自体は音声化されず、応答本文だけが発話されます。",
      ...
      noPdfsLocal: "インポートされたPDFはありません",
      pdfImportFile: "PDFファイルをローカルデータベースにインポート",
      pdfRefreshLocal: "ローカルPDFリストを更新",
      pdfClearLocal: "ローカルデータベースからすべてのPDFを削除",
      knowledgeBase: "ナレッジベース",
      libSaveCurrent: "現在の会話をナレッジベースに保存",
      libSaveShort: "保存",
      libRefresh: "ナレッジベース一覧を更新",
      libSaveModalTitle: "会話をナレッジベースに保存",
      libTitleLabel: "タイトル（任意）",
      libTitleHint: "空欄の場合はアプリ名がタイトルとして使われます。",
      libScopeLabel: "スコープ",
      libScopeAppOnlyLabel: "App-only（同一アプリ＋プロバイダ）",
      libScopeAppOnlyDesc: "同じアプリ＋プロバイダの組み合わせからのみ参照可能。",
      libScopeGlobalLabel: "Global（全アプリ共有）",
      libScopeGlobalDesc: "すべてのアプリから library_search 経由で参照可能。",
      libScopeGlobalWarning: "Global エントリはこの Monadic Chat の全アプリから検索可能になります。このマシンを使う人 (将来選ぶかもしれないアプリも含む) が library_search で取得できる状態になるため、明示的に共有したい会話以外は App-only を選んでください。",
      libBadgePiiHeuristic: "PII を含む可能性があります (タイトル / ソースに email または電話番号らしきパターンを検出)",
      libSaveButton: "保存",
      libEmpty: "ナレッジベースは空です。",
      libSaveSuccess: "ナレッジベースに保存しました。",
      libSaveModalTitleUpdate: "ナレッジベースの会話を更新",
      libUpdateButton: "更新",
      libUpdateNote: "この会話の以前の保存内容を置き換えます。",
      libUpdateSuccess: "ナレッジベースのエントリを更新しました。",
      libSuggestingTitle: "タイトルを提案中…",
      libSaveFailure: "保存に失敗しました",
      libSavingButton: "保存中...",
      libSavingMessage: "会話をナレッジベースに保存しています...",
      libNoMessages: "保存できる会話がまだありません。",
      libSaveAppUnsupported: "このアプリはナレッジベースへの保存に対応していません。",
      libSavePrivacyActive: "プライバシーフィルターが有効なセッションでは保存できません。",
      libImportFile: "ファイルを読み込み",
      libImportTooltip: "Markdown / PDF / Office / コードファイルをナレッジベースに読み込みます",
      libImportingButton: "読み込み中...",
      libImportingMessage: "ファイルをナレッジベースに読み込んでいます...",
      libImportStageQueued: "読み込み待機中…",
      libImportStageExtracting: "テキストを抽出しています…",
      libImportStageEmbedding: "埋め込みを生成して保存しています…",
      libImportSuccess: "ナレッジベースに読み込みました",
      libImportFailure: "読み込みに失敗しました",
      libRagToggleLabel: "このセッションでナレッジベース検索を使う",
      libRagToggleHint: "ON のとき、ツール対応アプリが shareable な会話を library_search で参照できます。デフォルト OFF。",
      libBrowseAll: "保存した全会話を閲覧",
      libBrowseAllShort: "一覧",
      libRecentLabel: "最近の保存:",
      libBrowseModalTitle: "ナレッジベース ブラウザ",
      libBrowsePlaceholder: "タイトル / source / 言語で検索...",
      libBrowseAllScopes: "すべてのスコープ",
      libSortNewest: "新しい順",
      libSortOldest: "古い順",
      libSortTitleAsc: "タイトル A→Z",
      libSortTurnsDesc: "ターン数が多い順",
      libColType: "種類",
      libColTypeTooltip: "コンテンツの種類 (conversation / pdf / document / code / ...)",
      libColTitle: "タイトル",
      libColScope: "スコープ",
      libColTurns: "ターン",
      libColCreated: "保存日",
      libBrowseEmpty: "フィルタ条件に一致する会話がありません。",
      libPrev: "前へ",
      libNext: "次へ",
      libDetailTitle: "会話の詳細",
      libMakeAppOnly: "App-only にする: {app}",
      libMakeAppOnlyDisabled: "アプリを選択するとスコープを切り替えられます",
      libMakeGlobal: "Global にする",
      libDelete: "削除",
      libClose: "閉じる",
      libViewDetails: "詳細を表示",
      libDeleteConfirm: "「{title}」をナレッジベースから完全に削除しますか?",
      libScopeUpdated: "スコープを更新しました。",
      libRenameTooltip: "この会話の名前を変更",
      libRenamePlaceholder: "会話のタイトル",
      libRenameSave: "保存",
      libRenameCancel: "キャンセル",
      libRenameSuccess: "タイトルを更新しました。",
      libRenameFailure: "名前変更に失敗しました",
      libRenameEmpty: "タイトルは空にできません",
      libFiltered: "件を表示",
      libShowing: "表示",
      libViewerTitle: "会話ビューア",
      libViewerSystemPrompt: "システムプロンプト",
      libViewerClickToExpand: "クリックで展開",
      libViewerEmpty: "この会話には本文が保存されていません。再保存するとビューアで閲覧できます。",
      libViewerLoading: "会話を読み込み中...",
      libViewerLoadFailure: "この会話を読み込めませんでした。",
      libViewerSkipped: "本文は保存されていません (",
      sessionLabel: "セッション操作",
      sessionContext: "セッションコンテキスト",
      contextTurnLegend: "T = ターン",
      saveChanges: "保存",
      speech: "音声",
      ...
      fileToImportAll: "インポートするファイル（画像、PDF、XLSX、DOCX、CSV等）",
      ...
      privacyFilterUnsupported: "このアプリはプライバシーフィルターに対応していません。",
      privacyFilterNotInstalled: "プライバシーフィルターは無効になっています。",
      privacyFilterLanguageNotInstalled: "この言語向けのプライバシーフィルターはインストールされていません。設定 → Install Options から追加してください。",
      privacyFilterCaption: "AI に送信する前に、名前・メールアドレス・電話番号などを伏せ字に置き換えます。会話開始後は変更できません（リセットで再設定可）。",
      exportDialogTitle: "会話をエクスポート",
      exportEncryptLabel: "パスフレーズで暗号化",
      exportEncryptHint: "AES-256-GCM + Argon2id でファイルを保管時に保護します。共有・アーカイブ・同期するファイルには推奨。",
      exportPassphrase: "パスフレーズ",
      exportPassphraseConfirm: "確認入力",
      exportPassphrasePlaceholder: "パスフレーズを入力",
      exportPassphraseWarning: "このパスフレーズはデータを復元する唯一の手段です。Monadic Chat ではリセットできません。",
      exportContent: "内容",
      exportContentRestored: "復元 — 元の氏名や情報を含めて出力",
      exportContentMasked: "伏せ字のみ — 個人情報なし、レジストリ非含有",
      privacyRegistryEmpty: "個人情報はまだ伏せ字化されていません。",
      exportPlainWarningTitle: "平文エクスポートを選択中。",
      exportPlainWarningBody: "出力ファイルは暗号化されません。信頼できるローカル用途のみで使用してください。",
      exportRestoredStrongTitle: "個人情報が平文でディスクに書き出されます。",
      exportRestoredStrongBody: "Privacy Filter が有効なセッションですが、暗号化なしで「Restored」を選んで安全側のデフォルトを上書きしようとしています。出力ファイルには会話に登場した名前・メール・住所・電話番号がすべてそのまま含まれます。原文を残す必要がない場合は「暗号化してエクスポート」または content の選択を「Masked」に戻してください。",
      exportContinue: "エクスポート",
      theme: "テーマ",
      themeSystem: "システム",
      themeLight: "ライト",
      themeDark: "ダーク",
      ...
      modals: {
        ...
        saveToKnowledgeBase: "ナレッジベースに保存",
      ...
      messages: {
        ...
        responseInterrupted: "中断されました",
        lcStart: "開始",
        lcIntro: "「ライブ会話を開始」を押すと会話が始まります。以降はハンズフリーで、ターンは自動的に検出されます。終えるときは「ライブ会話を終了」を押してください。ヘッドホンの使用を推奨します。",
        lcIdleStopped: "しばらく発話がなかったため、ライブ会話を終了しました。",
        lcVoice: "音声",
        lcSpeed: "速度",
        lcCardView: "会話中もカード表示",
        lcTools: "ツール",
        lcTurnDetection: "ターン判定",
        lcTurnSilence: "無音で判定（既定）",
        lcTurnLow: "意味で判定・ゆっくり",
        lcTurnMedium: "意味で判定・標準",
        lcTurnHigh: "意味で判定・すばやく",
        lcToolUsing: "{tool} を使用中…",
        lcRoleUser: "あなた",
        lcRoleAssistant: "アシスタント",
        lcStop: "終了",
        lcConnecting: "接続中…",
        lcListening: "聞き取り中…",
        lcUserSpeaking: "あなたが話しています…",
        lcAssistantSpeaking: "アシスタントが話しています…",
        lcReconnecting: "再接続中…",
        lcMicFailed: "マイクにアクセスできませんでした。権限を確認して再試行してください。",
        stsStreamStartFailed: "音声対話の音声取得に失敗しました。マイクのアクセスを確認するか、リアルタイム以外のモデルに切り替えてください。",
        stsEstimatedCost: "推定コスト（上限）",
        stsEstimatedCostPerMinute: "推定コスト（分単位課金）",
        stsEstimateShort: "推定",
        readyToStart: "開始準備完了",
        verifyingToken: "トークンを検証中",
        tokenVerificationTimeout: "トークン検証がタイムアウトしました。限定的な機能で続行します。",
        ...
        generatingAIUserResponse: "AIユーザー応答中...",
        aiUserResponseGenerated: "AI応答完了",
        generatingResponse: "応答生成中...",
        ...
        spinnerProcessingAudio: "音声処理中",
        spinnerUpdatingContext: "コンテキスト更新中",
        gpt5CodexAnalyzing: "GPT-5-Codexが要件を分析中",
        gpt5CodexGenerating: "GPT-5-Codexがコードを生成中",
        gpt5CodexDelegating: "GPT-5-Codex専門エージェントに委譲中",
        grokCodeGenerating: "Grok のコード生成エージェントがコードを生成中",
        grokCodeDelegating: "Grok のコード生成エージェントに委譲中",
        ...
        openaiCodeAnalyzing: "OpenAI のコード生成エージェントが要件を分析中",
        openaiCodeGenerating: "OpenAI のコード生成エージェントがコードを生成中",
        openaiCodeStructuring: "OpenAI のコード生成エージェントがソリューションを構築中",
        openaiCodeOptimizing: "OpenAI のコード生成エージェントが実装を最適化中",
        openaiCodeFinalizing: "OpenAI のコード生成エージェントが出力を完成中",
        claudeCodeAnalyzing: "Claude のコード生成エージェントが要件を分析中",
        claudeCodeGenerating: "Claude のコード生成エージェントがコードを生成中",
        claudeCodeStructuring: "Claude のコード生成エージェントがソリューションを構築中",
        claudeCodeOptimizing: "Claude のコード生成エージェントが実装を最適化中",
        claudeCodeFinalizing: "Claude のコード生成エージェントが出力を仕上げ中",
        grokCodeAnalyzing: "Grok のコード生成エージェントが要件を分析中",
        grokCodeGenerating2: "Grok のコード生成エージェントがコードを生成中",
        grokCodeFinalizing: "Grok のコード生成エージェントが出力を仕上げ中",
        ...
        validTokenNotSet: "有効なOpenAIトークンが設定されていません",
        cannotConnectToAPI: "OpenAI APIに接続できません",
  ...
  zh: {
    ui: {
      helpData: {
        title: "帮助数据",
        description: "安装随附的文档以用于帮助搜索。安装不需要API密钥。",
        checking: "正在检查帮助数据...",
        not_installed: "尚未安装帮助数据。",
        installing: "正在安装帮助数据...",
        installed: "帮助数据已可搜索。",
        update_available: "帮助数据有可用更新。您可以继续搜索已安装的版本。",
        legacy: "搜索前需要重新安装帮助数据。",
        failed: "帮助数据安装失败。",
        unavailable: "帮助数据服务不可用。",
        install: "安装",
        update: "更新",
        reinstall: "重新安装",
        retry: "重试安装",
        ...
        verifying: "正在验证安装",
        completed: "已完成",
        busy: "帮助数据正忙。请检查状态并在需要时重试。",
        startFailed: "无法开始安装。请检查服务后重试。"
      },
      verify: {
      ...
      fileToImportAll: "要导入的文件（图像、PDF、XLSX、DOCX、CSV 等）",
      ...
      privacyFilter: "隐私过滤器",
      privacyFilterUnsupported: "此应用不支持隐私过滤器。",
      privacyFilterNotInstalled: "隐私过滤器已禁用。",
      privacyFilterLanguageNotInstalled: "尚未为该语言安装隐私过滤器。请通过 设置 → Install Options 进行安装。",
      privacyFilterCaption: "在发送给 AI 之前对姓名、电子邮件和电话号码进行掩码处理。本会话发送消息后将锁定，重置可重新设置。",
      privacyRegistryEmpty: "尚未对个人信息进行掩码处理。",
      exportDialogTitle: "导出对话",
      exportEncryptLabel: "使用密码短语加密",
      exportEncryptHint: "使用 AES-256-GCM + Argon2id 保护导出文件的静态安全。建议用于共享、归档或同步的文件。",
      exportPassphrase: "密码短语",
      exportPassphraseConfirm: "确认",
      exportPassphrasePlaceholder: "请输入密码短语",
      exportPassphraseWarning: "此密码短语是恢复数据的唯一方式。Monadic Chat 无法重置。",
      exportContent: "内容",
      exportContentRestored: "已还原 — 包含原始姓名和详细信息",
      exportContentMasked: "仅占位符 — 不含个人信息和注册表",
      exportPlainWarningTitle: "已选择明文导出。",
      exportPlainWarningBody: "导出的文件将包含未加密的内容。仅用于受信任的本地工作流程。",
      exportRestoredStrongTitle: "个人信息将以明文写入磁盘。",
      exportRestoredStrongBody: "此会话已启用隐私过滤器,但您选择了不加密的\"Restored\",覆盖了更安全的默认值。导出的文件将包含会话中可见的所有姓名、电子邮件、地址和电话号码。如果不需要明文 PII 离开此机器,请选择\"加密并导出\"或将内容选项切换回\"Masked\"。",
      exportContinue: "导出",
      theme: "主题",
      themeSystem: "系统",
      themeLight: "浅色",
      ...
      contextTurnLegend: "T = 轮次",
      saveChanges: "保存",
      pdfDatabase: "PDF数据库",
      noPdfsLocal: "未导入PDF",
      pdfImportFile: "将PDF文件导入到本地数据库",
      pdfRefreshLocal: "刷新本地PDF列表",
      pdfClearLocal: "清除本地数据库中的所有PDF",
      knowledgeBase: "知识库",
      libSaveCurrent: "将当前对话保存到知识库",
      libSaveShort: "保存",
      libRefresh: "刷新知识库列表",
      libSaveModalTitle: "保存对话到知识库",
      libTitleLabel: "标题（可选）",
      libTitleHint: "留空时将使用应用名称作为标题。",
      libScopeLabel: "范围",
      libScopeAppOnlyLabel: "仅本应用",
      libScopeAppOnlyDesc: "仅可从同一应用 + 提供方检索。",
      libScopeGlobalLabel: "全局",
      libScopeGlobalDesc: "所有应用均可通过 library_search 检索。",
      libScopeGlobalWarning: "全局条目可被此 Monadic Chat 安装中的所有应用通过 library_search 检索到。包括将来您还未选择的应用,任何能访问此机器的人都可以检索到此内容。除非您有意共享此对话,否则请优先选择\"App-only\"。",
      libBadgePiiHeuristic: "可能包含个人信息 (在标题/来源中检测到电子邮件或电话模式)",
      libSaveButton: "保存",
      libEmpty: "知识库为空。",
      libSaveSuccess: "已保存到知识库。",
      libSaveModalTitleUpdate: "更新知识库中的对话",
      libUpdateButton: "更新",
      libUpdateNote: "这将替换此对话的上一次保存版本。",
      libUpdateSuccess: "已更新知识库条目。",
      libSuggestingTitle: "正在生成标题…",
      libSaveFailure: "保存失败",
      libSavingButton: "保存中...",
      libSavingMessage: "正在将对话保存到知识库...",
      libNoMessages: "暂无可保存的对话。",
      libSaveAppUnsupported: "此应用不支持保存到知识库。",
      libSavePrivacyActive: "本会话中已启用隐私过滤器，无法保存。",
      libImportFile: "导入文件",
      libImportTooltip: "将 Markdown / PDF / Office / 代码文件导入知识库",
      libImportingButton: "导入中...",
      libImportingMessage: "正在将文件导入知识库...",
      libImportStageQueued: "已加入导入队列…",
      libImportStageExtracting: "正在提取文本…",
      libImportStageEmbedding: "正在生成嵌入并保存…",
      libImportSuccess: "已导入知识库",
      libImportFailure: "导入失败",
      libRagToggleLabel: "本会话使用知识库进行检索",
      libRagToggleHint: "开启时，支持工具的应用可通过 library_search 检索可共享对话。默认关闭。",
      libBrowseAll: "浏览所有已保存的对话",
      libBrowseAllShort: "浏览",
      libRecentLabel: "最近保存:",
      libBrowseModalTitle: "知识库浏览器",
      libBrowsePlaceholder: "搜索标题 / 来源 / 语言...",
      libBrowseAllScopes: "所有范围",
      libSortNewest: "最新优先",
      libSortOldest: "最旧优先",
      libSortTitleAsc: "标题 A→Z",
      libSortTurnsDesc: "回合数最多",
      libColType: "类型",
      libColTypeTooltip: "内容类型 (conversation / pdf / document / code / ...)",
      libColTitle: "标题",
      libColScope: "范围",
      libColTurns: "回合",
      libColCreated: "保存于",
      libBrowseEmpty: "没有匹配的对话。",
      libPrev: "上一页",
      libNext: "下一页",
      libDetailTitle: "对话详情",
      libMakeAppOnly: "设为仅本应用: {app}",
      libMakeAppOnlyDisabled: "请先切换到某个应用以设置范围",
      libMakeGlobal: "设为全局",
      libDelete: "删除",
      libClose: "关闭",
      libViewDetails: "查看详情",
      libDeleteConfirm: "确定要从知识库永久删除「{title}」吗?",
      libScopeUpdated: "范围已更新。",
      libRenameTooltip: "重命名此对话",
      libRenamePlaceholder: "对话标题",
      libRenameSave: "保存",
      libRenameCancel: "取消",
      libRenameSuccess: "标题已更新。",
      libRenameFailure: "重命名失败",
      libRenameEmpty: "标题不能为空",
      libFiltered: "已筛选",
      libShowing: "显示",
      libViewerTitle: "对话查看器",
      libViewerSystemPrompt: "系统提示",
      libViewerClickToExpand: "点击展开",
      libViewerEmpty: "此对话未存储原文消息。重新保存可在查看器中查看。",
      libViewerLoading: "正在加载对话...",
      libViewerLoadFailure: "无法加载此对话。",
      libViewerSkipped: "未存储原文消息 (",
      ...
      workflowViewerLoadFailed: "工作流查看器加载失败。",
      workflowViewerRetry: "重试",
      workflowViewerHidden: "隐藏",
      workflowViewerInline: "面板内",
      workflowViewerFloating: "浮动",
      status: "状态",
      mode: "模式",
      standalone: "单机",
      server: "服务器",
      ...
      speechToTextModel: "语音转文本模型",
      sttNoModelsAvailable: "没有可用的语音转文本模型（需要 API 密钥）",
      expressiveSpeech: "富表达语音",
      expressiveSpeechTooltip: "所选 TTS 引擎会解释助手回复中嵌入的语音标记（停顿、笑声、耳语），使语音更富有表现力。支持: xAI Grok / ElevenLabs v3 / Gemini TTS。",
      expressiveSpeechInstructionsTooltip: "助手会以带外参数的形式发送语音指令（音色、节奏、情绪），由 OpenAI gpt-4o-mini-tts 引擎朗读回复时参考，但指令本身不会被朗读。",
      ...
      messages: {
        ...
        responseInterrupted: "已中断",
        lcStart: "开始",
        lcIntro: "按「开始实时对话」即可开始。之后无需操作，系统会自动检测发言轮次。结束时请按「结束实时对话」。建议使用耳机。",
        lcIdleStopped: "长时间没有语音输入，实时对话已结束。",
        lcVoice: "语音",
        lcSpeed: "速度",
        lcCardView: "对话中也用卡片",
        lcTools: "工具",
        lcTurnDetection: "轮次判定",
        lcTurnSilence: "按静音判定（默认）",
        lcTurnLow: "按语义判定·较慢",
        lcTurnMedium: "按语义判定·标准",
        lcTurnHigh: "按语义判定·较快",
        lcToolUsing: "正在使用 {tool}…",
        lcRoleUser: "你",
        lcRoleAssistant: "助手",
        lcStop: "结束",
        lcConnecting: "连接中…",
        lcListening: "正在聆听…",
        lcUserSpeaking: "您正在说话…",
        lcAssistantSpeaking: "助手正在说话…",
        lcReconnecting: "重新连接中…",
        lcMicFailed: "无法访问麦克风。请检查权限后重试。",
        stsStreamStartFailed: "语音对话的音频采集失败。请检查麦克风权限，或切换到非实时模型。",
        stsEstimatedCost: "预计费用（上限）",
        stsEstimatedCostPerMinute: "预计费用（按分钟计费）",
        stsEstimateShort: "预计",
        readyToStart: "准备开始",
        verifyingToken: "验证令牌中",
        tokenVerificationTimeout: "令牌验证超时。继续使用有限功能。",
        operationTimedOut: "操作超时。UI已重置。",
        languageChanged: "语言已更改为",
        webSpeechNotAvailable: "此浏览器不支持语音识别API",
        analyzingConversation: "分析对话中",
        generatingAIUserResponse: "AI用户响应中...",
        aiUserResponseGenerated: "AI响应就绪",
        generatingResponse: "生成响应中...",
        ...
        spinnerProcessingAudio: "处理音频中",
        spinnerUpdatingContext: "正在更新上下文",
        gpt5CodexAnalyzing: "GPT-5-Codex正在分析需求",
        gpt5CodexGenerating: "GPT-5-Codex正在生成代码",
        gpt5CodexDelegating: "委托给GPT-5-Codex专业代理",
        grokCodeGenerating: "Grok 代码生成代理正在生成代码",
        grokCodeDelegating: "委托给 Grok 代码生成代理",
        imageGenerating: "生成图像中",
        videoAnalyzing: "分析视频内容",
        secondOpinionProcessing: "获取第二意见",
        ...
        openaiCodeAnalyzing: "OpenAI 代码生成代理正在分析需求",
        openaiCodeGenerating: "OpenAI 代码生成代理正在生成代码",
        openaiCodeStructuring: "OpenAI 代码生成代理正在构建解决方案",
        openaiCodeOptimizing: "OpenAI 代码生成代理正在优化实现",
        openaiCodeFinalizing: "OpenAI 代码生成代理正在完成输出",
        claudeCodeAnalyzing: "Claude 代码生成代理正在分析需求",
        claudeCodeGenerating: "Claude 代码生成代理正在生成代码",
        claudeCodeStructuring: "Claude 代码生成代理正在构建解决方案",
        claudeCodeOptimizing: "Claude 代码生成代理正在优化实现",
        claudeCodeFinalizing: "Claude 代码生成代理正在完成输出",
        grokCodeAnalyzing: "Grok 代码生成代理正在分析需求",
        grokCodeGenerating2: "Grok 代码生成代理正在生成代码",
        grokCodeFinalizing: "Grok 代码生成代理正在完成输出",
  ...
  ko: {
    ui: {
      helpData: {
        title: "도움말 데이터",
        description: "도움말 검색을 위해 포함된 문서를 설치합니다. 설치에는 API 키가 필요하지 않습니다.",
        checking: "도움말 데이터 확인 중...",
        not_installed: "도움말 데이터가 설치되지 않았습니다.",
        installing: "도움말 데이터 설치 중...",
        installed: "도움말 데이터를 검색할 수 있습니다.",
        update_available: "도움말 데이터 업데이트가 있습니다. 설치된 버전을 계속 검색할 수 있습니다.",
        legacy: "검색하려면 도움말 데이터를 다시 설치해야 합니다.",
        failed: "도움말 데이터 설치에 실패했습니다.",
        unavailable: "도움말 데이터 서비스를 사용할 수 없습니다.",
        install: "설치",
        update: "업데이트",
        reinstall: "다시 설치",
        retry: "설치 재시도",
        ...
        verifying: "설치 확인 중",
        completed: "완료",
        busy: "도움말 데이터가 처리 중입니다. 상태를 확인하고 필요하면 다시 시도하세요.",
        startFailed: "설치를 시작할 수 없습니다. 서비스를 확인하고 다시 시도하세요."
      },
      verify: {
      ...
      fileToImportAll: "가져올 파일 (이미지, PDF, XLSX, DOCX, CSV 등)",
      ...
      privacyFilterUnsupported: "이 앱은 개인정보 필터를 지원하지 않습니다.",
      privacyFilterNotInstalled: "개인정보 필터가 비활성화되어 있습니다.",
      privacyFilterLanguageNotInstalled: "이 언어용 개인정보 필터가 설치되어 있지 않습니다. 설정 → Install Options 에서 추가하세요.",
      privacyFilterCaption: "AI에 전송하기 전에 이름, 이메일, 전화번호 등을 마스킹합니다. 메시지를 한 번 보내면 잠금되며, 재설정으로 다시 변경할 수 있습니다.",
      privacyRegistryEmpty: "아직 마스킹된 개인정보가 없습니다.",
      exportDialogTitle: "대화 내보내기",
      exportEncryptLabel: "암호 구문으로 암호화",
      exportEncryptHint: "AES-256-GCM + Argon2id로 저장 시 파일을 보호합니다. 공유, 보관 또는 동기화할 파일에 권장됩니다.",
      exportPassphrase: "암호 구문",
      exportPassphraseConfirm: "확인",
      exportPassphrasePlaceholder: "암호 구문 입력",
      exportPassphraseWarning: "이 암호 구문은 데이터를 복구하는 유일한 방법입니다. Monadic Chat은 재설정할 수 없습니다.",
      exportContent: "내용",
      exportContentRestored: "복원 — 원본 이름과 세부 정보 포함",
      exportContentMasked: "마스킹만 — 개인정보 없음, 레지스트리 없음",
      exportPlainWarningTitle: "일반 내보내기 선택됨.",
      exportPlainWarningBody: "내보낸 파일은 암호화되지 않은 내용을 포함합니다. 신뢰할 수 있는 로컬 작업 흐름에만 사용하세요.",
      exportRestoredStrongTitle: "개인 정보가 평문으로 디스크에 기록됩니다.",
      exportRestoredStrongBody: "이 세션에서 개인 정보 필터가 활성화되어 있지만, 암호화 없이 \"Restored\"를 선택하여 더 안전한 기본값을 무시하려 하고 있습니다. 내보낸 파일에는 대화에 표시된 이름, 이메일, 주소, 전화번호가 모두 포함됩니다. 평문 개인 정보를 이 기기 밖으로 내보낼 필요가 없다면 \"암호화 후 내보내기\"를 선택하거나 콘텐츠 라디오를 \"Masked\"로 되돌리세요.",
      exportContinue: "내보내기",
      theme: "테마",
      themeSystem: "시스템",
      themeLight: "밝게",
      ...
      speech: "음성",
      sessionLabel: "세션 제어",
      sessionContext: "세션 컨텍스트",
      contextTurnLegend: "T = 턴",
      saveChanges: "저장",
      pdfDatabase: "PDF 데이터베이스",
      noPdfsLocal: "가져온 PDF 없음",
      pdfImportFile: "PDF 파일을 로컬 데이터베이스로 가져오기",
      pdfRefreshLocal: "로컬 PDF 목록 새로고침",
      pdfClearLocal: "로컬 데이터베이스의 모든 PDF 삭제",
      knowledgeBase: "지식 베이스",
      libSaveCurrent: "현재 대화를 지식 베이스에 저장",
      libSaveShort: "저장",
      libRefresh: "지식 베이스 목록 새로고침",
      libSaveModalTitle: "대화를 지식 베이스에 저장",
      libTitleLabel: "제목 (선택)",
      libTitleHint: "비워두면 앱 이름이 제목으로 사용됩니다.",
      libScopeLabel: "범위",
      libScopeAppOnlyLabel: "앱 전용",
      libScopeAppOnlyDesc: "동일한 앱 + 제공자에서만 검색됩니다.",
      libScopeGlobalLabel: "전체 공개",
      libScopeGlobalDesc: "모든 앱에서 library_search 로 검색할 수 있습니다.",
      libScopeGlobalWarning: "전체 공개 항목은 이 Monadic Chat 설치 내의 모든 앱에서 library_search 로 검색할 수 있습니다. 아직 선택하지 않은 앱을 포함해, 이 기기에 접근할 수 있는 누구나 이 내용을 가져올 수 있습니다. 의도적으로 공유하려는 대화가 아니라면 App-only 를 선택하세요.",
      libBadgePiiHeuristic: "개인 정보를 포함할 가능성 (제목/소스에서 이메일 또는 전화번호 패턴 감지)",
      libSaveButton: "저장",
      libEmpty: "지식 베이스가 비어 있습니다.",
      libSaveSuccess: "지식 베이스에 저장했습니다.",
      libSaveModalTitleUpdate: "지식 베이스의 대화 업데이트",
      libUpdateButton: "업데이트",
      libUpdateNote: "이 대화의 이전에 저장된 버전을 대체합니다.",
      libUpdateSuccess: "지식 베이스 항목을 업데이트했습니다.",
      libSuggestingTitle: "제목 제안 중…",
      libSaveFailure: "저장 실패",
      libSavingButton: "저장 중...",
      libSavingMessage: "대화를 지식 베이스에 저장 중...",
      libNoMessages: "저장할 대화가 아직 없습니다.",
      libSaveAppUnsupported: "이 앱은 지식 베이스 저장을 지원하지 않습니다.",
      libSavePrivacyActive: "이 세션에서 프라이버시 필터가 활성화되어 있어 저장할 수 없습니다.",
      libImportFile: "파일 가져오기",
      libImportTooltip: "Markdown / PDF / Office / 코드 파일을 지식 베이스로 가져옵니다",
      libImportingButton: "가져오는 중...",
      libImportingMessage: "파일을 지식 베이스로 가져오는 중...",
      libImportStageQueued: "가져오기 대기 중…",
      libImportStageExtracting: "텍스트 추출 중…",
      libImportStageEmbedding: "임베딩 생성 및 저장 중…",
      libImportSuccess: "지식 베이스로 가져왔습니다",
      libImportFailure: "가져오기에 실패했습니다",
      libRagToggleLabel: "이 세션에서 지식 베이스 검색 사용",
      libRagToggleHint: "켜져 있으면 도구를 지원하는 앱이 library_search 로 공유 가능 대화를 검색합니다. 기본값 OFF.",
      libBrowseAll: "저장된 모든 대화 보기",
      libBrowseAllShort: "탐색",
      libRecentLabel: "최근 저장:",
      libBrowseModalTitle: "지식 베이스 브라우저",
      libBrowsePlaceholder: "제목 / 소스 / 언어 검색...",
      libBrowseAllScopes: "모든 범위",
      libSortNewest: "최신 순",
      libSortOldest: "오래된 순",
      libSortTitleAsc: "제목 A→Z",
      libSortTurnsDesc: "턴 수가 많은 순",
      libColType: "유형",
      libColTypeTooltip: "콘텐츠 유형 (conversation / pdf / document / code / ...)",
      libColTitle: "제목",
      libColScope: "범위",
      libColTurns: "턴",
      libColCreated: "저장 시각",
      libBrowseEmpty: "조건에 맞는 대화가 없습니다.",
      libPrev: "이전",
      libNext: "다음",
      libDetailTitle: "대화 상세",
      libMakeAppOnly: "앱 전용으로 변경: {app}",
      libMakeAppOnlyDisabled: "범위를 지정하려면 앱을 선택하세요",
      libMakeGlobal: "전체 공개로 변경",
      libDelete: "삭제",
      libClose: "닫기",
      libViewDetails: "상세 보기",
      libDeleteConfirm: "지식 베이스에서 \"{title}\" 을(를) 영구히 삭제하시겠습니까?",
      libScopeUpdated: "범위가 업데이트되었습니다.",
      libRenameTooltip: "이 대화의 이름 변경",
      libRenamePlaceholder: "대화 제목",
      libRenameSave: "저장",
      libRenameCancel: "취소",
      libRenameSuccess: "제목이 업데이트되었습니다.",
      libRenameFailure: "이름 변경에 실패했습니다",
      libRenameEmpty: "제목은 비워 둘 수 없습니다",
      libFiltered: "필터링됨",
      libShowing: "표시",
      libViewerTitle: "대화 뷰어",
      libViewerSystemPrompt: "시스템 프롬프트",
      libViewerClickToExpand: "클릭하여 펼치기",
      libViewerEmpty: "이 대화의 원문 메시지가 저장되어 있지 않습니다. 다시 저장하면 뷰어에서 볼 수 있습니다.",
      libViewerLoading: "대화 로드 중...",
      libViewerLoadFailure: "대화를 로드할 수 없습니다.",
      libViewerSkipped: "원문 메시지가 저장되지 않았습니다 (",
      ...
      cancelQuery: "쿼리 취소",
      toggleMenu: "메뉴 토글",
      workflowViewer: "워크플로 뷰어",
      workflowViewerLoadFailed: "워크플로 뷰어를 불러오지 못했습니다.",
      workflowViewerRetry: "다시 시도",
      workflowViewerHidden: "숨김",
      workflowViewerInline: "패널 안",
      workflowViewerFloating: "플로팅",
      status: "상태",
      mode: "모드",
      standalone: "독립형",
      server: "서버",
      ...
      speechToTextModel: "음성 텍스트 변환 모델",
      sttNoModelsAvailable: "사용 가능한 음성 인식 모델이 없습니다 (API 키 필요)",
      expressiveSpeech: "표현적 음성",
      expressiveSpeechTooltip: "선택된 TTS 엔진이 어시스턴트의 응답에 포함된 음성 마커(멈춤, 웃음, 속삭임)를 해석하여 표현력 있게 읽어줍니다. 지원: xAI Grok / ElevenLabs v3 / Gemini TTS.",
      expressiveSpeechInstructionsTooltip: "어시스턴트가 별도의 파라미터로 음성 지시(톤, 템포, 감정)를 전달하면 OpenAI gpt-4o-mini-tts 엔진이 이를 읽고 표현력 있게 응답을 낭독합니다. 지시문 자체는 음성화되지 않습니다.",
      ...
      modals: {
        ...
        saveToKnowledgeBase: "지식 베이스에 저장",
      ...
      messages: {
        ...
        responseInterrupted: "중단됨",
        lcStart: "시작",
        lcIntro: "「실시간 대화 시작」을 누르면 대화가 시작됩니다. 이후에는 핸즈프리로 진행되며 발화 차례가 자동으로 감지됩니다. 마칠 때는 「실시간 대화 종료」를 누르세요. 헤드폰 사용을 권장합니다.",
        lcIdleStopped: "한동안 음성 입력이 없어 실시간 대화를 종료했습니다.",
        lcVoice: "음성",
        lcSpeed: "속도",
        lcCardView: "대화 중에도 카드",
        lcTools: "도구",
        lcTurnDetection: "턴 판정",
        lcTurnSilence: "무음으로 판정(기본)",
        lcTurnLow: "의미로 판정·느리게",
        lcTurnMedium: "의미로 판정·표준",
        lcTurnHigh: "의미로 판정·빠르게",
        lcToolUsing: "{tool} 사용 중…",
        lcRoleUser: "사용자",
        lcRoleAssistant: "어시스턴트",
        lcStop: "종료",
        lcConnecting: "연결 중…",
        lcListening: "듣는 중…",
        lcUserSpeaking: "말하는 중…",
        lcAssistantSpeaking: "어시스턴트가 말하는 중…",
        lcReconnecting: "재연결 중…",
        lcMicFailed: "마이크에 접근할 수 없습니다. 권한을 확인하고 다시 시도하세요.",
        stsStreamStartFailed: "음성 대화의 오디오 캡처에 실패했습니다. 마이크 접근을 확인하거나 비실시간 모델로 전환하세요.",
        stsEstimatedCost: "예상 비용(상한)",
        stsEstimatedCostPerMinute: "예상 비용(분당 과금)",
        stsEstimateShort: "추정",
        readyToStart: "시작 준비 완료",
        verifyingToken: "토큰 확인 중",
        tokenVerificationTimeout: "토큰 확인 시간 초과. 제한된 기능으로 계속합니다.",
        ...
        generatingAIUserResponse: "AI 사용자 응답 중...",
        ...
        spinnerProcessingAudio: "오디오 처리 중",
        spinnerUpdatingContext: "컨텍스트 업데이트 중",
        gpt5CodexAnalyzing: "GPT-5-Codex가 요구사항을 분석 중",
        gpt5CodexGenerating: "GPT-5-Codex가 코드를 생성 중",
        gpt5CodexDelegating: "GPT-5-Codex 전문 에이전트에 위임 중",
        grokCodeGenerating: "Grok 코드 생성 에이전트가 코드를 생성 중",
        grokCodeDelegating: "Grok 코드 생성 에이전트에 위임 중",
        imageGenerating: "이미지 생성 중",
        videoAnalyzing: "비디오 콘텐츠 분석 중",
        secondOpinionProcessing: "세컨드 오피니언 요청 중",
        ...
        openaiCodeAnalyzing: "OpenAI 코드 생성 에이전트가 요구사항을 분석 중",
        openaiCodeGenerating: "OpenAI 코드 생성 에이전트가 코드를 생성 중",
        openaiCodeStructuring: "OpenAI 코드 생성 에이전트가 솔루션을 구성 중",
        openaiCodeOptimizing: "OpenAI 코드 생성 에이전트가 구현을 최적화 중",
        openaiCodeFinalizing: "OpenAI 코드 생성 에이전트가 출력을 마무리 중",
        claudeCodeAnalyzing: "Claude 코드 생성 에이전트가 요구사항을 분석 중",
        claudeCodeGenerating: "Claude 코드 생성 에이전트가 코드를 생성 중",
        claudeCodeStructuring: "Claude 코드 생성 에이전트가 솔루션을 구성 중",
        claudeCodeOptimizing: "Claude 코드 생성 에이전트가 구현을 최적화 중",
        claudeCodeFinalizing: "Claude 코드 생성 에이전트가 출력을 마무리 중",
        grokCodeAnalyzing: "Grok 코드 생성 에이전트가 요구사항을 분석 중",
        grokCodeGenerating2: "Grok 코드 생성 에이전트가 코드를 생성 중",
        grokCodeFinalizing: "Grok 코드 생성 에이전트가 출력을 마무리 중",
        ...
        validTokenNotSet: "유효한 OpenAI 토큰이 설정되지 않았습니다",
        cannotConnectToAPI: "OpenAI API에 연결할 수 없습니다",
  ...
  es: {
    ui: {
      helpData: {
        ...
        description: "Instala la documentación incluida para buscar en la ayuda. No se necesita una clave API para instalarla.",
        checking: "Comprobando los datos de ayuda...",
        not_installed: "Los datos de ayuda no están instalados.",
        installing: "Instalando los datos de ayuda...",
        installed: "Los datos de ayuda están listos para buscar.",
        update_available: "Hay una actualización de los datos de ayuda. Puedes seguir buscando en la versión instalada.",
        legacy: "Es necesario reinstalar los datos de ayuda antes de buscar.",
        failed: "La instalación de los datos de ayuda falló.",
        unavailable: "El servicio de datos de ayuda no está disponible.",
        install: "Instalar",
        update: "Actualizar",
        ...
        back: "Volver al chat",
        validating: "Validando documentación",
        preparing: "Preparando instalación",
        loading: "Cargando documentación",
        verifying: "Verificando instalación",
        completed: "Completado",
        busy: "Los datos de ayuda están ocupados. Comprueba el estado y vuelve a intentarlo si es necesario.",
        startFailed: "No se pudo iniciar la instalación. Comprueba el servicio y vuelve a intentarlo."
      },
      verify: {
      ...
      interactionControls: "Interacción",
      ...
      fileToImportAll: "Archivo para importar (imágenes, PDF, XLSX, DOCX, CSV, etc.)",
      ...
      privacyFilterUnsupported: "Esta aplicación no admite el Filtro de privacidad.",
      privacyFilterNotInstalled: "El Filtro de privacidad está deshabilitado.",
      privacyFilterLanguageNotInstalled: "El Filtro de privacidad no está instalado para este idioma. Instálelo desde Configuración → Install Options.",
      privacyFilterCaption: "Enmascara nombres, correos y números de teléfono antes de enviarlos a la IA. Se bloquea al enviar el primer mensaje (reiníciese para cambiarlo).",
      privacyRegistryEmpty: "Aún no se ha enmascarado ninguna información personal.",
      exportDialogTitle: "Exportar conversación",
      exportEncryptLabel: "Cifrar con frase de contraseña",
      exportEncryptHint: "Proteja el archivo exportado en reposo usando AES-256-GCM + Argon2id. Recomendado para archivos que se compartirán, archivarán o sincronizarán.",
      exportPassphrase: "Frase de contraseña",
      exportPassphraseConfirm: "Confirmar",
      exportPassphrasePlaceholder: "Ingrese una frase de contraseña",
      exportPassphraseWarning: "Esta frase de contraseña es la ÚNICA forma de recuperar sus datos. Monadic Chat no puede restablecerla.",
      exportContent: "Contenido",
      exportContentRestored: "Restaurado — nombres y detalles originales reconstruidos",
      exportContentMasked: "Enmascarado — solo marcadores, sin registro",
      exportPlainWarningTitle: "Exportación en texto plano seleccionada.",
      exportPlainWarningBody: "El archivo exportado contendrá contenido sin cifrar. Use solo para flujos locales de confianza.",
      exportRestoredStrongTitle: "Se escribirá PII en disco en texto plano.",
      exportRestoredStrongBody: "El filtro de privacidad está activo en esta sesión, pero está anulando el valor predeterminado más seguro al elegir \"Restored\" sin cifrado. El archivo exportado contendrá todos los nombres, correos, direcciones y teléfonos visibles en la conversación. Elija \"Cifrar y Exportar\" o vuelva a \"Masked\" si no necesita que la PII en texto plano salga de esta máquina.",
      ...
      speech: "Voz",
      sessionLabel: "Controles de sesión",
      sessionContext: "Contexto de sesión",
      contextTurnLegend: "T = Turno",
      saveChanges: "Guardar",
      pdfDatabase: "Base de datos PDF",
      noPdfsLocal: "No se han importado PDFs",
      pdfImportFile: "Importar archivo PDF a la base de datos local",
      pdfRefreshLocal: "Actualizar lista de PDF locales",
      pdfClearLocal: "Eliminar todos los PDF de la base de datos local",
      knowledgeBase: "Base de conocimiento",
      libSaveCurrent: "Guardar la conversación actual en la base de conocimiento",
      libSaveShort: "Guardar",
      libRefresh: "Actualizar la lista de la base de conocimiento",
      libSaveModalTitle: "Guardar conversación en la base de conocimiento",
      libTitleLabel: "Título (opcional)",
      libTitleHint: "Si se deja en blanco, se usa el nombre de la app como título.",
      libScopeLabel: "Alcance",
      libScopeAppOnlyLabel: "Solo esta app",
      libScopeAppOnlyDesc: "Solo recuperable desde la misma app + proveedor.",
      libScopeGlobalLabel: "Global",
      libScopeGlobalDesc: "Recuperable desde cualquier app mediante library_search.",
      libScopeGlobalWarning: "Las entradas Global son consultables desde todas las apps de esta instalación de Monadic Chat. Cualquier persona con acceso a esta máquina — incluidas apps que aún no haya elegido — puede recuperar este contenido vía library_search. Prefiera \"App-only\" salvo que la conversación esté pensada para ser compartida.",
      libBadgePiiHeuristic: "Puede contener PII (patrón de email o teléfono detectado en título/fuente)",
      libSaveButton: "Guardar",
      libEmpty: "La base de conocimiento está vacía.",
      libSaveSuccess: "Guardado en la base de conocimiento.",
      libSaveModalTitleUpdate: "Actualizar conversación en la base de conocimiento",
      libUpdateButton: "Actualizar",
      libUpdateNote: "Esto reemplazará la versión guardada anterior de esta conversación.",
      libUpdateSuccess: "Entrada de la base de conocimiento actualizada.",
      libSuggestingTitle: "Sugiriendo título…",
      libSaveFailure: "Error al guardar",
      libSavingButton: "Guardando...",
      libSavingMessage: "Guardando conversación en la base de conocimiento...",
      libNoMessages: "Aún no hay mensajes para guardar.",
      libSaveAppUnsupported: "Esta aplicación no admite guardar en la base de conocimiento.",
      libSavePrivacyActive: "El guardado está deshabilitado mientras el filtro de privacidad esté activo en esta sesión.",
      libImportFile: "Importar archivo",
      libImportTooltip: "Importa un archivo Markdown / PDF / Office / código a la base de conocimiento",
      libImportingButton: "Importando...",
      libImportingMessage: "Importando archivo a la base de conocimiento...",
      libImportStageQueued: "En cola para importar…",
      libImportStageExtracting: "Extrayendo texto…",
      libImportStageEmbedding: "Generando embeddings y guardando…",
      libImportSuccess: "Importado a la base de conocimiento",
      libImportFailure: "Error al importar",
      libRagToggleLabel: "Usar la base de conocimiento para recuperación (esta sesión)",
      libRagToggleHint: "Cuando esté activo, las apps con soporte de herramientas pueden recuperar conversaciones compartibles mediante library_search. Predeterminado: OFF.",
      libBrowseAll: "Explorar todas las conversaciones guardadas",
      libBrowseAllShort: "Explorar",
      libRecentLabel: "Guardados recientes:",
      libBrowseModalTitle: "Explorador de la base de conocimiento",
      libBrowsePlaceholder: "Buscar título, fuente, idioma...",
      libBrowseAllScopes: "Todos los alcances",
      libSortNewest: "Más reciente primero",
      libSortOldest: "Más antiguo primero",
      libSortTitleAsc: "Título A→Z",
      libSortTurnsDesc: "Más turnos",
      libColType: "Tipo",
      libColTypeTooltip: "Tipo de contenido (conversation / pdf / document / code / ...)",
      libColTitle: "Título",
      libColScope: "Alcance",
      libColTurns: "Turnos",
      libColCreated: "Guardado",
      libBrowseEmpty: "Ninguna conversación coincide con los filtros.",
      libPrev: "Anterior",
      libNext: "Siguiente",
      libDetailTitle: "Detalles de la conversación",
      libMakeAppOnly: "Solo esta app: {app}",
      libMakeAppOnlyDisabled: "Cambia a una app para definir el alcance",
      libMakeGlobal: "Hacer global",
      libDelete: "Eliminar",
      libClose: "Cerrar",
      libViewDetails: "Ver detalles",
      libDeleteConfirm: "¿Eliminar permanentemente \"{title}\" de la base de conocimiento?",
      libScopeUpdated: "Alcance actualizado.",
      libRenameTooltip: "Renombrar esta conversación",
      libRenamePlaceholder: "Título de la conversación",
      libRenameSave: "Guardar",
      libRenameCancel: "Cancelar",
      libRenameSuccess: "Título actualizado.",
      libRenameFailure: "Error al renombrar",
      libRenameEmpty: "El título no puede estar vacío",
      libFiltered: "filtrado",
      libShowing: "Mostrando",
      libViewerTitle: "Visor de conversación",
      libViewerSystemPrompt: "Prompt del sistema",
      libViewerClickToExpand: "haz clic para expandir",
      libViewerEmpty: "No se almacenaron mensajes textuales para esta conversación. Vuelve a guardarla para habilitar el Visor.",
      libViewerLoading: "Cargando conversación...",
      libViewerLoadFailure: "No se pudo cargar esta conversación.",
      libViewerSkipped: "Los mensajes textuales no se almacenaron (",
      ...
      workflowViewer: "Visor de flujo",
      workflowViewerLoadFailed: "Error al cargar el visor de flujo.",
      workflowViewerRetry: "Reintentar",
      workflowViewerHidden: "Oculto",
      workflowViewerInline: "En panel",
      workflowViewerFloating: "Flotante",
      status: "Estado",
      mode: "Modo",
      ...
      expressiveSpeech: "Habla Expresiva",
      expressiveSpeechTooltip: "El motor TTS seleccionado interpreta marcadores de habla (pausas, risas, susurros) que el asistente incorpora en sus respuestas. Compatible con xAI Grok, ElevenLabs v3 y Gemini TTS.",
      expressiveSpeechInstructionsTooltip: "El asistente envía una directiva vocal fuera de banda (tono, ritmo, emoción) que el motor OpenAI gpt-4o-mini-tts interpreta pero no pronuncia. Solo se habla el texto de la respuesta, con estilo expresivo acorde al contenido.",
      speechToTextModel: "Modelo de voz a texto",
      sttNoModelsAvailable: "No hay modelos de voz a texto disponibles (se requiere clave API)",
      ...
      image: "Imagen",
      fromFile: "Texto desde archivo",
      fromURL: "Texto desde URL",
      ...
      modals: {
        ...
        saveToKnowledgeBase: "Guardar en la base de conocimiento",
        ...
        fileUrlLabel: "O ingrese la URL del archivo",
        fileToImport: "Archivo para importar",
      ...
      messages: {
        ...
        responseInterrupted: "Interrumpido",
        lcStart: "Iniciar",
        lcIntro: "Pulsa \"Iniciar conversación en vivo\" para empezar. Después todo es manos libres: los turnos se detectan automáticamente. Pulsa \"Terminar conversación en vivo\" para acabar. Se recomiendan auriculares.",
        lcIdleStopped: "Sin voz durante un tiempo: la conversación en vivo ha terminado.",
        lcVoice: "Voz",
        lcSpeed: "Velocidad",
        lcCardView: "Tarjetas al hablar",
        lcTools: "Herramientas",
        lcTurnDetection: "Detección de turno",
        lcTurnSilence: "Por silencio (predeterminado)",
        lcTurnLow: "Por significado — paciente",
        lcTurnMedium: "Por significado — equilibrado",
        lcTurnHigh: "Por significado — rápido",
        lcToolUsing: "Usando {tool}…",
        lcRoleUser: "Tú",
        lcRoleAssistant: "Asistente",
        lcStop: "Terminar",
        lcConnecting: "Conectando…",
        lcListening: "Escuchando…",
        lcUserSpeaking: "Estás hablando…",
        lcAssistantSpeaking: "El asistente está hablando…",
        lcReconnecting: "Reconectando…",
        lcMicFailed: "No se pudo acceder al micrófono. Comprueba los permisos e inténtalo de nuevo.",
        stsStreamStartFailed: "Falló la captura de audio de voz a voz. Compruebe el acceso al micrófono o cambie a un modelo no en tiempo real.",
        stsEstimatedCost: "Coste estimado (límite superior)",
        stsEstimatedCostPerMinute: "Coste estimado (facturación por minuto)",
        stsEstimateShort: "est.",
        readyToStart: "Listo para comenzar",
        verifyingToken: "Verificando token",
        tokenVerificationTimeout: "Verificación de token agotada. Continuando con funcionalidad limitada.",
        ...
        generatingAIUserResponse: "Usuario IA respondiendo...",
        ...
        spinnerProcessingAudio: "Procesando audio",
        spinnerUpdatingContext: "Actualizando contexto",
        gpt5CodexAnalyzing: "GPT-5-Codex está analizando requisitos",
        gpt5CodexGenerating: "GPT-5-Codex está generando código",
        gpt5CodexDelegating: "Delegando a agente especialista GPT-5-Codex",
        grokCodeGenerating: "El agente de código de Grok está generando código",
        grokCodeDelegating: "Delegando al agente de código de Grok",
        imageGenerating: "Generando imagen",
        videoAnalyzing: "Analizando contenido de video",
        secondOpinionProcessing: "Obteniendo segunda opinión",
        ...
        openaiCodeAnalyzing: "El agente de código de OpenAI está analizando los requisitos",
        openaiCodeGenerating: "El agente de código de OpenAI está generando código",
        openaiCodeStructuring: "El agente de código de OpenAI está estructurando la solución",
        openaiCodeOptimizing: "El agente de código de OpenAI está optimizando la implementación",
        openaiCodeFinalizing: "El agente de código de OpenAI está finalizando la salida",
        claudeCodeAnalyzing: "El agente de código de Claude está analizando los requisitos",
        claudeCodeGenerating: "El agente de código de Claude está generando código",
        claudeCodeStructuring: "El agente de código de Claude está estructurando la solución",
        claudeCodeOptimizing: "El agente de código de Claude está optimizando la implementación",
        claudeCodeFinalizing: "El agente de código de Claude está finalizando la salida",
        grokCodeAnalyzing: "El agente de código de Grok está analizando los requisitos",
        grokCodeGenerating2: "El agente de código de Grok está generando código",
        grokCodeFinalizing: "El agente de código de Grok está finalizando la salida",
        ...
        validTokenNotSet: "Token de OpenAI válido no configurado",
        cannotConnectToAPI: "No se puede conectar a la API de OpenAI",
  ...
  fr: {
    ui: {
      helpData: {
        title: "Données d'aide",
        description: "Installez la documentation fournie pour rechercher dans l'aide. Aucune clé API n'est nécessaire pour l'installer.",
        checking: "Vérification des données d'aide...",
        not_installed: "Les données d'aide ne sont pas installées.",
        installing: "Installation des données d'aide...",
        installed: "Les données d'aide sont prêtes pour la recherche.",
        update_available: "Une mise à jour des données d'aide est disponible. Vous pouvez continuer à rechercher dans la version installée.",
        legacy: "Les données d'aide doivent être réinstallées avant la recherche.",
        failed: "L'installation des données d'aide a échoué.",
        unavailable: "Le service de données d'aide est indisponible.",
        install: "Installer",
        ...
        back: "Retour au chat",
        validating: "Validation de la documentation",
        preparing: "Préparation de l'installation",
        loading: "Chargement de la documentation",
        verifying: "Vérification de l'installation",
        completed: "Terminé",
        busy: "Les données d'aide sont occupées. Vérifiez leur état et réessayez si nécessaire.",
        startFailed: "Impossible de démarrer l'installation. Vérifiez le service et réessayez."
      },
      verify: {
      ...
      fileToImportAll: "Fichier à importer (images, PDF, XLSX, DOCX, CSV, etc.)",
      ...
      privacyFilterUnsupported: "Cette application ne prend pas en charge le filtre de confidentialité.",
      privacyFilterNotInstalled: "Le filtre de confidentialité est désactivé.",
      privacyFilterLanguageNotInstalled: "Le filtre de confidentialité n'est pas installé pour cette langue. Installez-le via Paramètres → Install Options.",
      privacyFilterCaption: "Masque les noms, adresses e-mail et numéros de téléphone avant l'envoi à l'IA. Verrouillé après l'envoi du premier message (réinitialisez pour modifier).",
      privacyRegistryEmpty: "Aucune information personnelle n'a encore été masquée.",
      exportDialogTitle: "Exporter la conversation",
      exportEncryptLabel: "Chiffrer avec une phrase secrète",
      exportEncryptHint: "Protégez le fichier exporté au repos avec AES-256-GCM + Argon2id. Recommandé pour les fichiers que vous comptez partager, archiver ou synchroniser.",
      exportPassphrase: "Phrase secrète",
      exportPassphraseConfirm: "Confirmer",
      exportPassphrasePlaceholder: "Entrez une phrase secrète",
      exportPassphraseWarning: "Cette phrase secrète est le SEUL moyen de récupérer vos données. Monadic Chat ne peut pas la réinitialiser.",
      exportContent: "Contenu",
      exportContentRestored: "Restauré — noms et détails d'origine reconstruits",
      exportContentMasked: "Masqué — uniquement les espaces réservés, sans registre",
      exportPlainWarningTitle: "Exportation en clair sélectionnée.",
      exportPlainWarningBody: "Le fichier exporté contiendra des données non chiffrées. À n'utiliser que pour des flux de travail locaux de confiance.",
      exportRestoredStrongTitle: "Les PII seront écrites en clair sur le disque.",
      exportRestoredStrongBody: "Le filtre de confidentialité est actif dans cette session, mais vous remplacez la valeur par défaut plus sûre en choisissant « Restored » sans chiffrement. Le fichier exporté contiendra tous les noms, e-mails, adresses et numéros de téléphone visibles dans la conversation. Choisissez « Chiffrer et exporter » ou revenez à « Masked » si vous n'avez pas besoin que les PII en clair quittent cette machine.",
      exportContinue: "Exporter",
      theme: "Thème",
      themeSystem: "Système",
      themeLight: "Clair",
      themeDark: "Sombre",
      ...
      speech: "Voix",
      sessionLabel: "Contrôles de session",
      sessionContext: "Contexte de session",
      contextTurnLegend: "T = Tour",
      saveChanges: "Enregistrer",
      pdfDatabase: "Base de données PDF",
      noPdfsLocal: "Aucun PDF importé",
      pdfImportFile: "Importer un fichier PDF dans la base de données locale",
      pdfRefreshLocal: "Actualiser la liste des PDF locaux",
      pdfClearLocal: "Supprimer tous les PDF de la base de données locale",
      knowledgeBase: "Base de connaissances",
      libSaveCurrent: "Enregistrer la conversation actuelle dans la base de connaissances",
      libSaveShort: "Enreg.",
      libRefresh: "Actualiser la liste de la base de connaissances",
      libSaveModalTitle: "Enregistrer la conversation dans la base de connaissances",
      libTitleLabel: "Titre (facultatif)",
      libTitleHint: "Si laissé vide, le nom de l'application sera utilisé comme titre.",
      libScopeLabel: "Portée",
      libScopeAppOnlyLabel: "App uniquement",
      libScopeAppOnlyDesc: "Récupérable uniquement depuis la même app + fournisseur.",
      libScopeGlobalLabel: "Global",
      libScopeGlobalDesc: "Récupérable depuis toutes les applications via library_search.",
      libScopeGlobalWarning: "Les entrées Global sont interrogeables depuis toutes les applications de cette installation de Monadic Chat. Toute personne ayant accès à cette machine — y compris depuis des applications que vous n'avez pas encore choisies — peut récupérer ce contenu via library_search. Préférez « App-only » sauf si la conversation est destinée à être partagée.",
      libBadgePiiHeuristic: "Peut contenir des PII (motif e-mail ou téléphone détecté dans le titre/la source)",
      libSaveButton: "Enregistrer",
      libEmpty: "La base de connaissances est vide.",
      libSaveSuccess: "Enregistré dans la base de connaissances.",
      libSaveModalTitleUpdate: "Mettre à jour la conversation dans la base de connaissances",
      libUpdateButton: "Mettre à jour",
      libUpdateNote: "Cela remplacera la version précédente enregistrée de cette conversation.",
      libUpdateSuccess: "Entrée de la base de connaissances mise à jour.",
      libSuggestingTitle: "Suggestion du titre…",
      libSaveFailure: "Échec de l'enregistrement",
      libSavingButton: "Enregistrement...",
      libSavingMessage: "Enregistrement de la conversation dans la base de connaissances...",
      libNoMessages: "Aucun message à enregistrer pour le moment.",
      libSaveAppUnsupported: "Cette application ne prend pas en charge l'enregistrement dans la base de connaissances.",
      libSavePrivacyActive: "L'enregistrement est désactivé tant que le filtre de confidentialité est actif dans cette session.",
      libImportFile: "Importer un fichier",
      libImportTooltip: "Importez un fichier Markdown / PDF / Office / code dans la base de connaissances",
      libImportingButton: "Importation...",
      libImportingMessage: "Importation du fichier dans la base de connaissances...",
      libImportStageQueued: "En file d'attente pour importation…",
      libImportStageExtracting: "Extraction du texte…",
      libImportStageEmbedding: "Génération des embeddings et enregistrement…",
      libImportSuccess: "Importé dans la base de connaissances",
      libImportFailure: "Échec de l'importation",
      libRagToggleLabel: "Utiliser la base de connaissances pour la recherche (cette session)",
      libRagToggleHint: "Lorsqu'il est activé, les applications compatibles avec les outils peuvent récupérer les conversations partageables via library_search. Désactivé par défaut.",
      libBrowseAll: "Parcourir toutes les conversations enregistrées",
      libBrowseAllShort: "Parcourir",
      libRecentLabel: "Enregistrements récents :",
      libBrowseModalTitle: "Navigateur de la base de connaissances",
      libBrowsePlaceholder: "Rechercher titre, source, langue...",
      libBrowseAllScopes: "Toutes les portées",
      libSortNewest: "Plus récent d'abord",
      libSortOldest: "Plus ancien d'abord",
      libSortTitleAsc: "Titre A→Z",
      libSortTurnsDesc: "Plus de tours",
      libColType: "Type",
      libColTypeTooltip: "Type de contenu (conversation / pdf / document / code / ...)",
      libColTitle: "Titre",
      libColScope: "Portée",
      libColTurns: "Tours",
      libColCreated: "Enregistré",
      libBrowseEmpty: "Aucune conversation ne correspond aux filtres.",
      libPrev: "Précédent",
      libNext: "Suivant",
      libDetailTitle: "Détails de la conversation",
      libMakeAppOnly: "Limiter à l'app: {app}",
      libMakeAppOnlyDisabled: "Sélectionnez une app pour définir la portée",
      libMakeGlobal: "Rendre global",
      libDelete: "Supprimer",
      libClose: "Fermer",
      libViewDetails: "Voir les détails",
      libDeleteConfirm: "Supprimer définitivement « {title} » de la base de connaissances ?",
      libScopeUpdated: "Portée mise à jour.",
      libRenameTooltip: "Renommer cette conversation",
      libRenamePlaceholder: "Titre de la conversation",
      libRenameSave: "Enregistrer",
      libRenameCancel: "Annuler",
      libRenameSuccess: "Titre mis à jour.",
      libRenameFailure: "Échec du renommage",
      libRenameEmpty: "Le titre ne peut pas être vide",
      libFiltered: "filtrés",
      libShowing: "Affichage",
      libViewerTitle: "Visualiseur de conversation",
      libViewerSystemPrompt: "Prompt système",
      libViewerClickToExpand: "cliquer pour développer",
      libViewerEmpty: "Aucun message textuel n'a été stocké pour cette conversation. Ré-enregistrez-la pour activer le Visualiseur.",
      libViewerLoading: "Chargement de la conversation...",
      libViewerLoadFailure: "Impossible de charger cette conversation.",
      libViewerSkipped: "Les messages textuels n'ont pas été stockés (",
      ...
      workflowViewer: "Visionneuse de flux",
      workflowViewerLoadFailed: "Échec du chargement du visualiseur de workflow.",
      workflowViewerRetry: "Réessayer",
      workflowViewerHidden: "Masqué",
      workflowViewerInline: "Dans le panneau",
      workflowViewerFloating: "Flottant",
      status: "État",
      mode: "Mode",
      standalone: "Autonome",
      server: "Serveur",
      ...
      expressiveSpeech: "Parole Expressive",
      expressiveSpeechTooltip: "Le moteur TTS sélectionné interprète les marqueurs vocaux (pauses, rires, chuchotements) que l'assistant intègre dans ses réponses. Pris en charge par xAI Grok, ElevenLabs v3 et Gemini TTS.",
      expressiveSpeechInstructionsTooltip: "L'assistant émet une directive vocale hors bande (ton, rythme, émotion) que le moteur OpenAI gpt-4o-mini-tts lit sans la prononcer. Seul le texte de la réponse est vocalisé, avec un style expressif adapté au contenu.",
      speechToTextModel: "Modèle de reconnaissance vocale",
      sttNoModelsAvailable: "Aucun modèle de reconnaissance vocale disponible (clé API requise)",
      ...
      image: "Image",
      fromFile: "Texte depuis fichier",
      fromURL: "Texte depuis URL",
      ...
      modals: {
        ...
        saveToKnowledgeBase: "Enregistrer dans la base de connaissances",
        ...
        fileUrlLabel: "Ou entrez l'URL du fichier",
        fileToImport: "Fichier à importer",
      ...
      messages: {
        ...
        responseInterrupted: "Interrompu",
        lcStart: "Démarrer",
        lcIntro: "Appuyez sur « Démarrer la conversation en direct » pour commencer. Ensuite tout est mains libres : les tours de parole sont détectés automatiquement. Appuyez sur « Terminer la conversation en direct » pour finir. Casque recommandé.",
        lcIdleStopped: "Aucune parole depuis un moment — la conversation en direct est terminée.",
        lcVoice: "Voix",
        lcSpeed: "Vitesse",
        lcCardView: "Cartes pendant l'échange",
        lcTools: "Outils",
        lcTurnDetection: "Détection du tour",
        lcTurnSilence: "Par silence (défaut)",
        lcTurnLow: "Par sens — patient",
        lcTurnMedium: "Par sens — équilibré",
        lcTurnHigh: "Par sens — rapide",
        lcToolUsing: "Utilisation de {tool}…",
        lcRoleUser: "Vous",
        lcRoleAssistant: "Assistant",
        lcStop: "Terminer",
        lcConnecting: "Connexion…",
        lcListening: "À l’écoute…",
        lcUserSpeaking: "Vous parlez…",
        lcAssistantSpeaking: "L’assistant parle…",
        lcReconnecting: "Reconnexion…",
        lcMicFailed: "Impossible d’accéder au micro. Vérifiez les autorisations et réessayez.",
        stsStreamStartFailed: "Échec de la capture audio voix-à-voix. Vérifiez l'accès au micro ou passez à un modèle non temps réel.",
        stsEstimatedCost: "Coût estimé (limite haute)",
        stsEstimatedCostPerMinute: "Coût estimé (facturation à la minute)",
        stsEstimateShort: "est.",
        readyToStart: "Prêt à démarrer",
        verifyingToken: "Vérification du jeton",
        tokenVerificationTimeout: "La vérification du jeton a expiré. Continuation avec des fonctionnalités limitées.",
        ...
        generatingAIUserResponse: "Utilisateur IA répond...",
        aiUserResponseGenerated: "Réponse IA prête",
        generatingResponse: "Génération en cours...",
        ...
        spinnerProcessingAudio: "Traitement audio",
        spinnerUpdatingContext: "Mise à jour du contexte",
        gpt5CodexAnalyzing: "GPT-5-Codex analyse les exigences",
        gpt5CodexGenerating: "GPT-5-Codex génère du code",
        gpt5CodexDelegating: "Délégation à l'agent spécialiste GPT-5-Codex",
        grokCodeGenerating: "L'agent de code Grok génère du code",
        grokCodeDelegating: "Délégation à l'agent de code Grok",
        imageGenerating: "Génération d'image",
        videoAnalyzing: "Analyse du contenu vidéo",
        secondOpinionProcessing: "Obtention d'un second avis",
        ...
        openaiCodeAnalyzing: "L'agent de code OpenAI analyse les exigences",
        openaiCodeGenerating: "L'agent de code OpenAI génère du code",
        openaiCodeStructuring: "L'agent de code OpenAI structure la solution",
        openaiCodeOptimizing: "L'agent de code OpenAI optimise l'implémentation",
        openaiCodeFinalizing: "L'agent de code OpenAI finalise la sortie",
        claudeCodeAnalyzing: "L'agent de code Claude analyse les exigences",
        claudeCodeGenerating: "L'agent de code Claude génère du code",
        claudeCodeStructuring: "L'agent de code Claude structure la solution",
        claudeCodeOptimizing: "L'agent de code Claude optimise l'implémentation",
        claudeCodeFinalizing: "L'agent de code Claude finalise la sortie",
        grokCodeAnalyzing: "L'agent de code Grok analyse les exigences",
        grokCodeGenerating2: "L'agent de code Grok génère du code",
        grokCodeFinalizing: "L'agent de code Grok finalise la sortie",
        ...
        validTokenNotSet: "Aucun jeton OpenAI valide configuré",
        cannotConnectToAPI: "Impossible de se connecter à l'API OpenAI",
  ...
  de: {
    ui: {
      helpData: {
        title: "Hilfedaten",
        description: "Installieren Sie die mitgelieferte Dokumentation für die Hilfesuche. Zur Installation ist kein API-Schlüssel erforderlich.",
        checking: "Hilfedaten werden geprüft...",
        not_installed: "Hilfedaten sind nicht installiert.",
        installing: "Hilfedaten werden installiert...",
        installed: "Hilfedaten können durchsucht werden.",
        update_available: "Ein Update der Hilfedaten ist verfügbar. Die installierte Version kann weiterhin durchsucht werden.",
        legacy: "Hilfedaten müssen vor der Suche neu installiert werden.",
        failed: "Die Installation der Hilfedaten ist fehlgeschlagen.",
        unavailable: "Der Hilfedatendienst ist nicht verfügbar.",
        install: "Installieren",
        update: "Aktualisieren",
        reinstall: "Neu installieren",
        retry: "Installation erneut versuchen",
        refresh: "Status aktualisieren",
        back: "Zurück zum Chat",
        validating: "Dokumentation wird validiert",
        preparing: "Installation wird vorbereitet",
        loading: "Dokumentation wird geladen",
        verifying: "Installation wird überprüft",
        completed: "Abgeschlossen",
        busy: "Die Hilfedaten werden gerade verarbeitet. Prüfen Sie den Status und versuchen Sie es bei Bedarf erneut.",
        startFailed: "Die Installation konnte nicht gestartet werden. Prüfen Sie den Dienst und versuchen Sie es erneut."
      },
      verify: {
      ...
      interactionControls: "Interaktion",
      ...
      fileToImportAll: "Zu importierende Datei (Bilder, PDF, XLSX, DOCX, CSV, etc.)",
      ...
      privacyFilterUnsupported: "Diese App unterstützt den Privatsphäre-Filter nicht.",
      privacyFilterNotInstalled: "Privatsphäre-Filter ist deaktiviert.",
      privacyFilterLanguageNotInstalled: "Privatsphäre-Filter ist für diese Sprache nicht installiert. Installieren Sie ihn über Einstellungen → Install Options.",
      privacyFilterCaption: "Maskiert Namen, E-Mail-Adressen und Telefonnummern vor dem Senden an die KI. Nach der ersten gesendeten Nachricht gesperrt (Zurücksetzen ändert dies).",
      privacyRegistryEmpty: "Es wurden noch keine persönlichen Informationen maskiert.",
      exportDialogTitle: "Konversation exportieren",
      exportEncryptLabel: "Mit Passphrase verschlüsseln",
      exportEncryptHint: "Schützt die exportierte Datei im Ruhezustand mit AES-256-GCM + Argon2id. Empfohlen für Dateien, die geteilt, archiviert oder synchronisiert werden.",
      exportPassphrase: "Passphrase",
      exportPassphraseConfirm: "Bestätigen",
      exportPassphrasePlaceholder: "Passphrase eingeben",
      exportPassphraseWarning: "Diese Passphrase ist die EINZIGE Möglichkeit, Ihre Daten wiederherzustellen. Monadic Chat kann sie nicht zurücksetzen.",
      exportContent: "Inhalt",
      exportContentRestored: "Wiederhergestellt — Originalnamen und Details rekonstruiert",
      exportContentMasked: "Maskiert — nur Platzhalter, keine Registry",
      exportPlainWarningTitle: "Klartext-Export ausgewählt.",
      exportPlainWarningBody: "Die exportierte Datei enthält unverschlüsselte Inhalte. Nur für vertrauenswürdige, lokale Arbeitsabläufe verwenden.",
      exportRestoredStrongTitle: "PII werden im Klartext auf die Festplatte geschrieben.",
      exportRestoredStrongBody: "Der Privacy Filter ist in dieser Sitzung aktiv, aber Sie überschreiben die sicherere Voreinstellung, indem Sie \"Restored\" ohne Verschlüsselung wählen. Die exportierte Datei enthält alle Namen, E-Mails, Adressen und Telefonnummern, die in der Unterhaltung sichtbar sind. Wählen Sie \"Verschlüsseln und Exportieren\" oder schalten Sie das Inhaltsradio zurück auf \"Masked\", wenn Sie nicht möchten, dass Klartext-PII diesen Rechner verlässt.",
      exportContinue: "Exportieren",
      theme: "Theme",
      themeSystem: "System",
      themeLight: "Hell",
      themeDark: "Dunkel",
      ...
      speech: "Sprache",
      sessionLabel: "Sitzungssteuerung",
      sessionContext: "Sitzungskontext",
      contextTurnLegend: "T = Runde",
      saveChanges: "Speichern",
      pdfDatabase: "PDF-Datenbank",
      noPdfsLocal: "Keine PDFs importiert",
      pdfImportFile: "PDF-Datei in lokale Datenbank importieren",
      pdfRefreshLocal: "Lokale PDF-Liste aktualisieren",
      pdfClearLocal: "Alle PDFs aus lokaler Datenbank löschen",
      knowledgeBase: "Wissensdatenbank",
      libSaveCurrent: "Aktuelles Gespräch in Wissensdatenbank speichern",
      libSaveShort: "Speichern",
      libRefresh: "Wissensdatenbank-Liste aktualisieren",
      libSaveModalTitle: "Gespräch in Wissensdatenbank speichern",
      libTitleLabel: "Titel (optional)",
      libTitleHint: "Wenn leer gelassen, wird der App-Name als Titel verwendet.",
      libScopeLabel: "Bereich",
      libScopeAppOnlyLabel: "Nur diese App",
      libScopeAppOnlyDesc: "Nur aus derselben App + Anbieter abrufbar.",
      libScopeGlobalLabel: "Global",
      libScopeGlobalDesc: "Aus jeder App über library_search abrufbar.",
      libScopeGlobalWarning: "Global-Einträge sind aus allen Apps dieser Monadic-Chat-Installation per library_search abrufbar. Jeder mit Zugriff auf diesen Rechner — einschließlich noch nicht ausgewählter Apps — kann diesen Inhalt abrufen. Bevorzugen Sie \"App-only\", außer die Unterhaltung soll bewusst geteilt werden.",
      libBadgePiiHeuristic: "Kann PII enthalten (E-Mail- oder Telefonmuster in Titel/Quelle erkannt)",
      libSaveButton: "Speichern",
      libEmpty: "Die Wissensdatenbank ist leer.",
      libSaveSuccess: "In Wissensdatenbank gespeichert.",
      libSaveModalTitleUpdate: "Gespräch in Wissensdatenbank aktualisieren",
      libUpdateButton: "Aktualisieren",
      libUpdateNote: "Dies ersetzt die zuvor gespeicherte Version dieses Gesprächs.",
      libUpdateSuccess: "Eintrag der Wissensdatenbank aktualisiert.",
      libSuggestingTitle: "Titel wird vorgeschlagen…",
      libSaveFailure: "Speichern fehlgeschlagen",
      libSavingButton: "Speichern...",
      libSavingMessage: "Speichere Gespräch in der Wissensdatenbank...",
      libNoMessages: "Noch keine Nachrichten zum Speichern.",
      libSaveAppUnsupported: "Diese App unterstützt das Speichern in der Wissensdatenbank nicht.",
      libSavePrivacyActive: "Speichern ist deaktiviert, solange der Datenschutzfilter in dieser Sitzung aktiv ist.",
      libImportFile: "Datei importieren",
      libImportTooltip: "Markdown / PDF / Office / Code-Datei in die Wissensdatenbank importieren",
      libImportingButton: "Importiere...",
      libImportingMessage: "Datei wird in die Wissensdatenbank importiert...",
      libImportStageQueued: "In Warteschlange für Import…",
      libImportStageExtracting: "Text wird extrahiert…",
      libImportStageEmbedding: "Embeddings werden erzeugt und gespeichert…",
      libImportSuccess: "In Wissensdatenbank importiert",
      libImportFailure: "Import fehlgeschlagen",
      libRagToggleLabel: "Wissensdatenbank für Abruf nutzen (diese Sitzung)",
      libRagToggleHint: "Wenn aktiviert, können Apps mit Tool-Unterstützung über library_search auf teilbare Gespräche zugreifen. Standard: AUS.",
      libBrowseAll: "Alle gespeicherten Gespräche durchsuchen",
      libBrowseAllShort: "Durchsuchen",
      libRecentLabel: "Letzte Speicherungen:",
      libBrowseModalTitle: "Wissensdatenbank-Browser",
      libBrowsePlaceholder: "Titel / Quelle / Sprache suchen...",
      libBrowseAllScopes: "Alle Bereiche",
      libSortNewest: "Neueste zuerst",
      libSortOldest: "Älteste zuerst",
      libSortTitleAsc: "Titel A→Z",
      libSortTurnsDesc: "Meiste Runden",
      libColType: "Typ",
      libColTypeTooltip: "Inhaltstyp (conversation / pdf / document / code / ...)",
      libColTitle: "Titel",
      libColScope: "Bereich",
      libColTurns: "Runden",
      libColCreated: "Gespeichert",
      libBrowseEmpty: "Keine Gespräche entsprechen den Filtern.",
      libPrev: "Zurück",
      libNext: "Weiter",
      libDetailTitle: "Gesprächsdetails",
      libMakeAppOnly: "Nur diese App: {app}",
      libMakeAppOnlyDisabled: "Wählen Sie eine App, um den Bereich zu setzen",
      libMakeGlobal: "Auf Global setzen",
      libDelete: "Löschen",
      libClose: "Schließen",
      libViewDetails: "Details anzeigen",
      libDeleteConfirm: "\"{title}\" dauerhaft aus der Wissensdatenbank löschen?",
      libScopeUpdated: "Bereich aktualisiert.",
      libRenameTooltip: "Diese Unterhaltung umbenennen",
      libRenamePlaceholder: "Titel der Unterhaltung",
      libRenameSave: "Speichern",
      libRenameCancel: "Abbrechen",
      libRenameSuccess: "Titel aktualisiert.",
      libRenameFailure: "Umbenennen fehlgeschlagen",
      libRenameEmpty: "Titel darf nicht leer sein",
      libFiltered: "gefiltert",
      libShowing: "Anzeige",
      libViewerTitle: "Konversations-Viewer",
      libViewerSystemPrompt: "System-Prompt",
      libViewerClickToExpand: "zum Ausklappen klicken",
      libViewerEmpty: "Für dieses Gespräch wurden keine wörtlichen Nachrichten gespeichert. Erneut speichern, um den Viewer zu aktivieren.",
      libViewerLoading: "Lade Gespräch...",
      libViewerLoadFailure: "Dieses Gespräch konnte nicht geladen werden.",
      libViewerSkipped: "Wörtliche Nachrichten wurden nicht gespeichert (",
      monadicChatInfo: "Monadic Chat Info",
      monadicChatStatus: "Monadic Chat Status",
      ...
      workflowViewer: "Workflow-Ansicht",
      workflowViewerLoadFailed: "Der Workflow-Viewer konnte nicht geladen werden.",
      workflowViewerRetry: "Erneut versuchen",
      workflowViewerHidden: "Versteckt",
      workflowViewerInline: "Im Bereich",
      workflowViewerFloating: "Schwebend",
      status: "Status",
      mode: "Modus",
      ...
      expressiveSpeech: "Ausdrucksvolle Sprache",
      expressiveSpeechTooltip: "Die ausgewählte TTS-Engine interpretiert Sprachmarkierungen (Pausen, Lachen, Flüstern), die der Assistent in seine Antworten einfügt. Unterstützt von xAI Grok, ElevenLabs v3 und Gemini TTS.",
      expressiveSpeechInstructionsTooltip: "Der Assistent sendet eine separate Sprachanweisung (Ton, Tempo, Emotion), die die OpenAI gpt-4o-mini-tts-Engine liest, aber nicht spricht. Nur der Antworttext wird vorgelesen — mit einem zum Inhalt passenden, ausdrucksstarken Stil.",
      speechToTextModel: "Sprache-zu-Text-Modell",
      sttNoModelsAvailable: "Keine Sprache-zu-Text-Modelle verfügbar (API-Schlüssel erforderlich)",
      ...
      image: "Bild",
      fromFile: "Text aus Datei",
      fromURL: "Text aus URL",
      ...
      modals: {
        ...
        fileUrlLabel: "Oder Datei-URL eingeben",
        fileToImport: "Zu importierende Datei",
      ...
      messages: {
        ...
        responseInterrupted: "Unterbrochen",
        lcStart: "Start",
        lcIntro: "Mit \"Live-Gespräch starten\" beginnt das Gespräch. Danach läuft alles freihändig — Gesprächsrunden werden automatisch erkannt. Zum Beenden \"Live-Gespräch beenden\" drücken. Kopfhörer werden empfohlen.",
        lcIdleStopped: "Längere Zeit keine Sprache — das Live-Gespräch wurde beendet.",
        lcVoice: "Stimme",
        lcSpeed: "Tempo",
        lcCardView: "Karten beim Sprechen",
        lcTools: "Werkzeuge",
        lcTurnDetection: "Gesprächswechsel-Erkennung",
        lcTurnSilence: "Nach Stille (Standard)",
        lcTurnLow: "Nach Sinn — geduldig",
        lcTurnMedium: "Nach Sinn — ausgewogen",
        lcTurnHigh: "Nach Sinn — schnell",
        lcToolUsing: "Verwende {tool}…",
        lcRoleUser: "Du",
        lcRoleAssistant: "Assistent",
        lcStop: "Beenden",
        lcConnecting: "Verbinden…",
        lcListening: "Höre zu…",
        lcUserSpeaking: "Sie sprechen…",
        lcAssistantSpeaking: "Der Assistent spricht…",
        lcReconnecting: "Wiederverbinden…",
        lcMicFailed: "Mikrofonzugriff fehlgeschlagen. Berechtigungen prüfen und erneut versuchen.",
        stsStreamStartFailed: "Sprach-zu-Sprache-Audioaufnahme fehlgeschlagen. Mikrofonzugriff prüfen oder zu einem Nicht-Echtzeit-Modell wechseln.",
        stsEstimatedCost: "Geschätzte Kosten (Obergrenze)",
        stsEstimatedCostPerMinute: "Geschätzte Kosten (Abrechnung pro Minute)",
        stsEstimateShort: "ca.",
        readyToStart: "Bereit zum Start",
        verifyingToken: "Token wird überprüft",
        tokenVerificationTimeout: "Token-Überprüfung abgelaufen. Fortfahren mit eingeschränkter Funktionalität.",
        ...
        generatingAIUserResponse: "KI-Benutzer antwortet...",
        ...
        spinnerProcessingAudio: "Audio verarbeiten",
        spinnerUpdatingContext: "Kontext wird aktualisiert",
        gpt5CodexAnalyzing: "GPT-5-Codex analysiert Anforderungen",
        gpt5CodexGenerating: "GPT-5-Codex generiert Code",
        gpt5CodexDelegating: "Delegieren an GPT-5-Codex-Spezialagenten",
        grokCodeGenerating: "Der Grok-Coding-Agent generiert Code",
        grokCodeDelegating: "Delegieren an den Grok-Coding-Agenten",
        imageGenerating: "Bild wird generiert",
        videoAnalyzing: "Videoinhalt wird analysiert",
        secondOpinionProcessing: "Zweite Meinung wird eingeholt",
        ...
        openaiCodeAnalyzing: "Der OpenAI-Coding-Agent analysiert die Anforderungen",
        openaiCodeGenerating: "Der OpenAI-Coding-Agent generiert Code",
        openaiCodeStructuring: "Der OpenAI-Coding-Agent strukturiert die Lösung",
        openaiCodeOptimizing: "Der OpenAI-Coding-Agent optimiert die Implementierung",
        openaiCodeFinalizing: "Der OpenAI-Coding-Agent finalisiert die Ausgabe",
        claudeCodeAnalyzing: "Der Claude-Coding-Agent analysiert die Anforderungen",
        claudeCodeGenerating: "Der Claude-Coding-Agent generiert Code",
        claudeCodeStructuring: "Der Claude-Coding-Agent strukturiert die Lösung",
        claudeCodeOptimizing: "Der Claude-Coding-Agent optimiert die Implementierung",
        claudeCodeFinalizing: "Der Claude-Coding-Agent finalisiert die Ausgabe",
        grokCodeAnalyzing: "Der Grok-Coding-Agent analysiert die Anforderungen",
        grokCodeGenerating2: "Der Grok-Coding-Agent generiert Code",
        grokCodeFinalizing: "Der Grok-Coding-Agent finalisiert die Ausgabe",
        ...
        validTokenNotSet: "Kein gültiges OpenAI-Token konfiguriert",
        cannotConnectToAPI: "Verbindung zur OpenAI-API nicht möglich",
