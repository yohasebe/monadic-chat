  ...
  en: {
    ui: {
      ...
      messages: {
        ...
        openaiCodeAnalyzing: "OpenAI Code is analyzing requirements",
        openaiCodeGenerating: "OpenAI Code is generating code",
        openaiCodeStructuring: "OpenAI Code is structuring the solution",
        openaiCodeOptimizing: "OpenAI Code is optimizing the implementation",
        openaiCodeFinalizing: "OpenAI Code is finalizing the output",
        claudeCodeAnalyzing: "Claude Code is analyzing requirements",
        claudeCodeGenerating: "Claude Code is generating code",
        claudeCodeStructuring: "Claude Code is structuring the solution",
        claudeCodeOptimizing: "Claude Code is optimizing the implementation",
        claudeCodeFinalizing: "Claude Code is finalizing the output",
        grokCodeAnalyzing: "Grok Code is analyzing requirements",
        grokCodeGenerating2: "Grok Code is generating code",
        grokCodeFinalizing: "Grok Code is finalizing the output",
  ...
  ja: {
    ui: {
      ...
      messages: {
        ...
        openaiCodeAnalyzing: "OpenAI Codeが要件を分析中",
        openaiCodeGenerating: "OpenAI Codeがコードを生成中",
        openaiCodeStructuring: "OpenAI Codeがソリューションを構築中",
        openaiCodeOptimizing: "OpenAI Codeが実装を最適化中",
        openaiCodeFinalizing: "OpenAI Codeが出力を完成中",
        claudeCodeAnalyzing: "Claude Codeが要件を分析中",
        claudeCodeGenerating: "Claude Codeがコードを生成中",
        claudeCodeStructuring: "Claude Codeがソリューションを構築中",
        claudeCodeOptimizing: "Claude Codeが実装を最適化中",
        claudeCodeFinalizing: "Claude Codeが出力を仕上げ中",
        grokCodeAnalyzing: "Grok Codeが要件を分析中",
        grokCodeGenerating2: "Grok Codeがコードを生成中",
        grokCodeFinalizing: "Grok Codeが出力を仕上げ中",
  ...
  zh: {
    ui: {
      ...
      messages: {
        ...
        grokCodeGenerating: "Grok-Code正在生成代码",
        grokCodeDelegating: "委托给Grok-Code专业代理",
        ...
        openaiCodeAnalyzing: "OpenAI Code 正在分析需求",
        openaiCodeGenerating: "OpenAI Code 正在生成代码",
        openaiCodeStructuring: "OpenAI Code 正在构建解决方案",
        openaiCodeOptimizing: "OpenAI Code 正在优化实现",
        openaiCodeFinalizing: "OpenAI Code 正在完成输出",
        claudeCodeAnalyzing: "Claude Code 正在分析需求",
        claudeCodeGenerating: "Claude Code 正在生成代码",
        claudeCodeStructuring: "Claude Code 正在构建解决方案",
        claudeCodeOptimizing: "Claude Code 正在优化实现",
        claudeCodeFinalizing: "Claude Code 正在完成输出",
        grokCodeAnalyzing: "Grok Code 正在分析需求",
        grokCodeGenerating2: "Grok Code 正在生成代码",
        grokCodeFinalizing: "Grok Code 正在完成输出",
  ...
  ko: {
    ui: {
      ...
      messages: {
        ...
        grokCodeGenerating: "Grok-Code가 코드를 생성 중",
        grokCodeDelegating: "Grok-Code 전문 에이전트에 위임 중",
        ...
        openaiCodeAnalyzing: "OpenAI Code가 요구사항을 분석 중",
        openaiCodeGenerating: "OpenAI Code가 코드를 생성 중",
        openaiCodeStructuring: "OpenAI Code가 솔루션을 구성 중",
        openaiCodeOptimizing: "OpenAI Code가 구현을 최적화 중",
        openaiCodeFinalizing: "OpenAI Code가 출력을 마무리 중",
        claudeCodeAnalyzing: "Claude Code가 요구사항을 분석 중",
        claudeCodeGenerating: "Claude Code가 코드를 생성 중",
        claudeCodeStructuring: "Claude Code가 솔루션을 구성 중",
        claudeCodeOptimizing: "Claude Code가 구현을 최적화 중",
        claudeCodeFinalizing: "Claude Code가 출력을 마무리 중",
        grokCodeAnalyzing: "Grok Code가 요구사항을 분석 중",
        grokCodeGenerating2: "Grok Code가 코드를 생성 중",
        grokCodeFinalizing: "Grok Code가 출력을 마무리 중",
  ...
  es: {
    ui: {
      ...
      messages: {
        ...
        grokCodeGenerating: "Grok-Code está generando código",
        grokCodeDelegating: "Delegando a agente especialista Grok-Code",
        ...
        openaiCodeAnalyzing: "OpenAI Code está analizando los requisitos",
        openaiCodeGenerating: "OpenAI Code está generando código",
        openaiCodeStructuring: "OpenAI Code está estructurando la solución",
        openaiCodeOptimizing: "OpenAI Code está optimizando la implementación",
        openaiCodeFinalizing: "OpenAI Code está finalizando la salida",
        claudeCodeAnalyzing: "Claude Code está analizando los requisitos",
        claudeCodeGenerating: "Claude Code está generando código",
        claudeCodeStructuring: "Claude Code está estructurando la solución",
        claudeCodeOptimizing: "Claude Code está optimizando la implementación",
        claudeCodeFinalizing: "Claude Code está finalizando la salida",
        grokCodeAnalyzing: "Grok Code está analizando los requisitos",
        grokCodeGenerating2: "Grok Code está generando código",
        grokCodeFinalizing: "Grok Code está finalizando la salida",
  ...
  fr: {
    ui: {
      ...
      messages: {
        ...
        grokCodeGenerating: "Grok-Code génère du code",
        grokCodeDelegating: "Délégation à l'agent spécialiste Grok-Code",
        ...
        openaiCodeAnalyzing: "OpenAI Code analyse les exigences",
        openaiCodeGenerating: "OpenAI Code génère du code",
        openaiCodeStructuring: "OpenAI Code structure la solution",
        openaiCodeOptimizing: "OpenAI Code optimise l'implémentation",
        openaiCodeFinalizing: "OpenAI Code finalise la sortie",
        claudeCodeAnalyzing: "Claude Code analyse les exigences",
        claudeCodeGenerating: "Claude Code génère du code",
        claudeCodeStructuring: "Claude Code structure la solution",
        claudeCodeOptimizing: "Claude Code optimise l'implémentation",
        claudeCodeFinalizing: "Claude Code finalise la sortie",
        grokCodeAnalyzing: "Grok Code analyse les exigences",
        grokCodeGenerating2: "Grok Code génère du code",
        grokCodeFinalizing: "Grok Code finalise la sortie",
  ...
  de: {
    ui: {
      ...
      messages: {
        ...
        grokCodeGenerating: "Grok-Code generiert Code",
        grokCodeDelegating: "Delegieren an Grok-Code-Spezialagenten",
        ...
        openaiCodeAnalyzing: "OpenAI Code analysiert die Anforderungen",
        openaiCodeGenerating: "OpenAI Code generiert Code",
        openaiCodeStructuring: "OpenAI Code strukturiert die Lösung",
        openaiCodeOptimizing: "OpenAI Code optimiert die Implementierung",
        openaiCodeFinalizing: "OpenAI Code finalisiert die Ausgabe",
        claudeCodeAnalyzing: "Claude Code analysiert die Anforderungen",
        claudeCodeGenerating: "Claude Code generiert Code",
        claudeCodeStructuring: "Claude Code strukturiert die Lösung",
        claudeCodeOptimizing: "Claude Code optimiert die Implementierung",
        claudeCodeFinalizing: "Claude Code finalisiert die Ausgabe",
        grokCodeAnalyzing: "Grok Code analysiert die Anforderungen",
        grokCodeGenerating2: "Grok Code generiert Code",
        grokCodeFinalizing: "Grok Code finalisiert die Ausgabe",
