...
const webUITranslations = {
  en: {
    ui: {
      ...
      libPrivacyNote: "Privacy Filter is on — text in the saved conversation is the restored (unmasked) version visible in the dialog.",
      libSaveButton: "Save",
  ...
  ja: {
    ui: {
      ...
      libPrivacyNote: "Privacy Filter が有効です。保存される本文は画面に表示されている復元（マスク解除）後のテキストです。",
      libSaveButton: "保存",
