...
window.loadedApp = "Chat";
  ...
  // updateAppAndModelSelection extracted to ws-app-data-handlers.js
  const updateAppAndModelSelection = (window.WsAppDataHandlers && window.WsAppDataHandlers.updateAppAndModelSelection) || function() {};
    ...
    switch (data["type"]) {
      ...
      case "apps": {
        ...
        if (window.pendingParameters) {
          ...
          window.logTL('post_apps_maybe_reset', { currentApp, isFirstAppsMessage, loadedApp: window.loadedApp });
