...
RSpec.describe "OpenAI Reasoning Content Extraction" do
  ...
  describe "Model compatibility" do
    it "supports o1 and o3 reasoning models" do
      models = ["o1-preview", "o1", "o1-mini", "o3-mini"]

      models.each do |model_name|
        is_reasoning = model_name.match?(/^o[13]/)
        expect(is_reasoning).to be true
      end
    end

    it "identifies non-reasoning OpenAI models" do
