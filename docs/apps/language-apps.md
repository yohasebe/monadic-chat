...
Apps for practicing, translating, and interpreting languages, with speech synthesis and voice input support for conversational learning.
...
Language Practice supports the providers indicated in the availability table. For speech synthesis settings, see [Speech Settings Panel](../basic-usage/web-interface.md#speech-settings-panel).
...
Voice Interpreter follows the provider availability shown in the table above. For speech synthesis settings, see [Speech Settings Panel](../basic-usage/web-interface.md#speech-settings-panel).
