...
- 📦 [Installer package for macOS ARM64 (Apple Silicon)](https://github.com/yohasebe/monadic-chat/releases/download/v1.0.0-beta.1/Monadic.Chat-1.0.0-beta-1-arm64.dmg)
- 📦 [Installer package for macOS x64 (Intel)](https://github.com/yohasebe/monadic-chat/releases/download/v1.0.0-beta.1/Monadic.Chat-1.0.0-beta-1-x64.dmg)
...
- 📦 [Installer package for Windows](https://github.com/yohasebe/monadic-chat/releases/download/v1.0.0-beta.1/Monadic.Chat.Setup.1.0.0-beta-1.exe)
...
- 📦 [Installer package for Linux (Ubuntu/Debian) x64](https://github.com/yohasebe/monadic-chat/releases/download/v1.0.0-beta.1/monadic-chat_1.0.0-beta-1_amd64.deb)
- 📦 [Installer package for Linux (Ubuntu/Debian) arm64](https://github.com/yohasebe/monadic-chat/releases/download/v1.0.0-beta.1/monadic-chat_1.0.0-beta-1_arm64.deb)
