...
語学の練習・翻訳・通訳のためのアプリです。音声合成と音声入力に対応し、会話形式での学習をサポートします。
...
Language Practiceの対応プロバイダーは冒頭の表を参照してください。音声合成の設定については[音声設定パネル](../basic-usage/web-interface.md#speech-settings-panel)を参照してください。
...
Voice Interpreterの対応プロバイダーは冒頭の表を参照してください。音声入出力の設定については[音声設定パネル](../basic-usage/web-interface.md#speech-settings-panel)を参照してください。
