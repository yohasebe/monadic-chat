...
- 📦 [macOS ARM64 (Apple Silicon) 用インストーラー](https://yohasebe.com/assets/apps/Monadic.Chat-0.9.74.dmg)
- 📦 [macOS x64 (Intel) 用インストーラー](https://yohasebe.com/assets/apps/Monadic.Chat-0.9.74.dmg)
...
- 📦 [Windows用インストーラー](https://yohasebe.com/assets/apps/Monadic.Chat.Setup.0.9.74.exe)
...
- 📦 [Linux (Ubuntu/Debian) x64用インストーラー](https://yohasebe.com/assets/apps/monadic-chat_0.9.74_amd64.deb)
- 📦 [Linux (Ubuntu/Debian) arm64用インストーラー](https://yohasebe.com/assets/apps/monadic-chat_0.9.74_arm64.deb)
