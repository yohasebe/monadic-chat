...
- 📦 [macOS ARM64 (Apple Silicon) 用インストーラー](https://yohasebe.com/assets/apps/Monadic%20Chat-0.9.72-arm64.dmg)
- 📦 [macOS x64 (Intel) 用インストーラー](https://yohasebe.com/assets/apps/Monadic%20Chat-0.9.72.dmg)

*バージョン 0.9.72。[GitHubリリースページ](https://github.com/yohasebe/monadic-chat/releases/latest)で、他のバージョンも確認できます。*
...
- 📦 [Windows用インストーラー](https://yohasebe.com/assets/apps/Monadic%20Chat%20Setup%200.9.72.exe)
...
- 📦 [Linux (Ubuntu/Debian) x64用インストーラー](https://yohasebe.com/assets/apps/monadic-chat_0.9.72_amd64.deb)
- 📦 [Linux (Ubuntu/Debian) arm64用インストーラー](https://yohasebe.com/assets/apps/monadic-chat_0.9.72_arm64.deb)
