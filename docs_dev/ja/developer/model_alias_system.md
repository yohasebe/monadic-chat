...
| フォーマット | 例 | プロバイダー | 備考 |
|--------|---------|----------|-------|
| `YYYY-MM-DD` | `gpt-5-2025-08-07` | OpenAI, xAI | 最も一般的 |
| `YYYYMMDD` | `claude-sonnet-4-5-20250929` | Claude | 8桁の日付 |
| `MM-YYYY` | `command-a-03-2025` | Cohere | 月-年フォーマット |
...
["command-a-08-2024", "command-a-03-2025", "command-a-12-2024"]
  => 最新: "command-a-03-2025" (2025年3月が最新)

// 文字列ソートでは誤って "command-a-12-2024" が選ばれる
```
...
**APIレスポンス**: `claude-sonnet-4-5-20250929`（日付付きのみ）を返す

**model_spec.js**: `claude-sonnet-4-5-20250929`の仕様を含む

**Web UI**: `claude-sonnet-4-5-20250929`を表示
...
command-a7b-12-2024  => 7bは無視、12-2024は日付（MM-YYYYフォーマット）
```
