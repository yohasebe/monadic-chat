...
| Google | `gemini-3.8-flash` (reasoning Flash; the 3.6 generation stays in the catalog) | `generate_content`, thinking level `low`/`medium`/`high`; thinking can be turned off with `thinkingBudget: 0` (measured 2026-09-22) |
